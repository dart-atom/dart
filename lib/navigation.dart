...
class NavigationManager {
  ...
  /// Sugar for [gotoLocation].
  void navigate(String path, int line, int column, [int length]) {
    gotoLocation(new NavigationLocation(path, new Span(line, column, length)));
  }
...
/**
 * A navigation location - a file path and [Span] tuple.
 */
...
class Span {
  ...
  Span(this.line, this.column, [this.length]);
