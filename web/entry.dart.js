...
// Generated by dart2js, the Dart to JavaScript compiler version: 1.11.0-dev.5.2.
...
(function() {
  ...
  init.precompiled = function($collectedClasses$) {
    ...
    function Atom(_commands, _config, _notifications, _packages, _project, _workspace, obj) {
    ...
    Atom.prototype = $desc;
    Atom.$__fields__ = ["_commands", "_config", "_notifications", "_packages", "_project", "_workspace", "obj"];
    ...
    function Workspace_observeTextEditors_closure(_captured_callback_0) {
    ...
    Workspace_observeTextEditors_closure.$__fields__ = ["_captured_callback_0"];
    function Panel(obj) {
      this.obj = obj;
      this.$deferredAction();
    }
    ...
    function CommandRegistry_add_closure(_captured_callback_0) {
      this._captured_callback_0 = _captured_callback_0;
      this.$deferredAction();
    }
    ...
    CommandRegistry_add_closure.$__fields__ = ["_captured_callback_0"];
    function Config(obj) {
      this.obj = obj;
      this.$deferredAction();
    }
    ...
    function AnalysisServer(subs, disposables, _serverActiveController, _serverBusyController, _allMessagesController, _server, _job, knownRoots) {
      this.subs = subs;
      this.disposables = disposables;
      this._serverActiveController = _serverActiveController;
      this._serverBusyController = _serverBusyController;
      this._allMessagesController = _allMessagesController;
    ...
    AnalysisServer.$__fields__ = ["subs", "disposables", "_serverActiveController", "_serverBusyController", "_allMessagesController", "_server", "_job", "knownRoots"];
    ...
    function AnalysisServer__setup__closure(_captured_explicit_1) {
      this._captured_explicit_1 = _captured_explicit_1;
      this.$deferredAction();
    }
    AnalysisServer__setup__closure.builtin$cls = "AnalysisServer__setup__closure";
    if (!"name" in AnalysisServer__setup__closure)
      AnalysisServer__setup__closure.name = "AnalysisServer__setup__closure";
    $desc = $collectedClasses$.AnalysisServer__setup__closure[1];
    AnalysisServer__setup__closure.prototype = $desc;
    AnalysisServer__setup__closure.$__fields__ = ["_captured_explicit_1"];
    ...
    function AnalysisServer__handleNewEditor_closure(_analysis_server$_captured_this_0, _captured_editor_1, _captured_path_2) {
      this._analysis_server$_captured_this_0 = _analysis_server$_captured_this_0;
      this._captured_editor_1 = _captured_editor_1;
      this._captured_path_2 = _captured_path_2;
      this.$deferredAction();
    }
    AnalysisServer__handleNewEditor_closure.builtin$cls = "AnalysisServer__handleNewEditor_closure";
    if (!"name" in AnalysisServer__handleNewEditor_closure)
      AnalysisServer__handleNewEditor_closure.name = "AnalysisServer__handleNewEditor_closure";
    $desc = $collectedClasses$.AnalysisServer__handleNewEditor_closure[1];
    AnalysisServer__handleNewEditor_closure.prototype = $desc;
    AnalysisServer__handleNewEditor_closure.$__fields__ = ["_analysis_server$_captured_this_0", "_captured_editor_1", "_captured_path_2"];
    function AnalysisServer__handleNewEditor_closure0(_analysis_server$_captured_this_3, _captured_path_4) {
      this._analysis_server$_captured_this_3 = _analysis_server$_captured_this_3;
      this._captured_path_4 = _captured_path_4;
      this.$deferredAction();
    }
    AnalysisServer__handleNewEditor_closure0.builtin$cls = "AnalysisServer__handleNewEditor_closure0";
    if (!"name" in AnalysisServer__handleNewEditor_closure0)
      AnalysisServer__handleNewEditor_closure0.name = "AnalysisServer__handleNewEditor_closure0";
    $desc = $collectedClasses$.AnalysisServer__handleNewEditor_closure0[1];
    AnalysisServer__handleNewEditor_closure0.prototype = $desc;
    AnalysisServer__handleNewEditor_closure0.$__fields__ = ["_analysis_server$_captured_this_3", "_captured_path_4"];
    ...
    function _DartLinterProvider(_severityMap, grammarScopes, scope, lintOnFly) {
      this._severityMap = _severityMap;
      this.grammarScopes = grammarScopes;
      this.scope = scope;
      this.lintOnFly = lintOnFly;
      this.$deferredAction();
    }
    _DartLinterProvider.builtin$cls = "_DartLinterProvider";
    if (!"name" in _DartLinterProvider)
      _DartLinterProvider.name = "_DartLinterProvider";
    $desc = $collectedClasses$._DartLinterProvider[1];
    _DartLinterProvider.prototype = $desc;
    _DartLinterProvider.$__fields__ = ["_severityMap", "grammarScopes", "scope", "lintOnFly"];
    function _DartLinterProvider_lint_closure(_analysis_server$_captured_this_0, _captured_filePath_1) {
      this._analysis_server$_captured_this_0 = _analysis_server$_captured_this_0;
      this._captured_filePath_1 = _captured_filePath_1;
      this.$deferredAction();
    }
    _DartLinterProvider_lint_closure.builtin$cls = "_DartLinterProvider_lint_closure";
    if (!"name" in _DartLinterProvider_lint_closure)
      _DartLinterProvider_lint_closure.name = "_DartLinterProvider_lint_closure";
    $desc = $collectedClasses$._DartLinterProvider_lint_closure[1];
    _DartLinterProvider_lint_closure.prototype = $desc;
    _DartLinterProvider_lint_closure.$__fields__ = ["_analysis_server$_captured_this_0", "_captured_filePath_1"];
    function _DartLinterProvider_lint__closure() {
      this.$deferredAction();
    }
    _DartLinterProvider_lint__closure.builtin$cls = "_DartLinterProvider_lint__closure";
    if (!"name" in _DartLinterProvider_lint__closure)
      _DartLinterProvider_lint__closure.name = "_DartLinterProvider_lint__closure";
    $desc = $collectedClasses$._DartLinterProvider_lint__closure[1];
    _DartLinterProvider_lint__closure.prototype = $desc;
    _DartLinterProvider_lint__closure.$__fields__ = [];
    function _DartLinterProvider_lint__closure0(_analysis_server$_captured_this_2, _captured_filePath_3) {
      this._analysis_server$_captured_this_2 = _analysis_server$_captured_this_2;
      this._captured_filePath_3 = _captured_filePath_3;
      this.$deferredAction();
    }
    _DartLinterProvider_lint__closure0.builtin$cls = "_DartLinterProvider_lint__closure0";
    if (!"name" in _DartLinterProvider_lint__closure0)
      _DartLinterProvider_lint__closure0.name = "_DartLinterProvider_lint__closure0";
    $desc = $collectedClasses$._DartLinterProvider_lint__closure0[1];
    _DartLinterProvider_lint__closure0.prototype = $desc;
    _DartLinterProvider_lint__closure0.$__fields__ = ["_analysis_server$_captured_this_2", "_captured_filePath_3"];
    function _DartLinterProvider_lint_closure0() {
      this.$deferredAction();
    }
    _DartLinterProvider_lint_closure0.builtin$cls = "_DartLinterProvider_lint_closure0";
    if (!"name" in _DartLinterProvider_lint_closure0)
      _DartLinterProvider_lint_closure0.name = "_DartLinterProvider_lint_closure0";
    $desc = $collectedClasses$._DartLinterProvider_lint_closure0[1];
    _DartLinterProvider_lint_closure0.prototype = $desc;
    _DartLinterProvider_lint_closure0.$__fields__ = [];
    function AnalysisServerDialog(_analysis_server_dialog$_disposables, _panel, _messageElement, _statusElement, _startButton, _stopButton) {
    ...
    AnalysisServerDialog.$__fields__ = ["_analysis_server_dialog$_disposables", "_panel", "_messageElement", "_statusElement", "_startButton", "_stopButton"];
    ...
    function AnalysisServerDialog_closure3(_captured_this_4) {
      this._captured_this_4 = _captured_this_4;
      this.$deferredAction();
    }
    AnalysisServerDialog_closure3.builtin$cls = "AnalysisServerDialog_closure3";
    if (!"name" in AnalysisServerDialog_closure3)
      AnalysisServerDialog_closure3.name = "AnalysisServerDialog_closure3";
    $desc = $collectedClasses$.AnalysisServerDialog_closure3[1];
    AnalysisServerDialog_closure3.prototype = $desc;
    AnalysisServerDialog_closure3.$__fields__ = ["_captured_this_4"];
    ...
    function AnalysisServerDialog_showDialog_closure0(_analysis_server_dialog$_captured_this_1) {
      this._analysis_server_dialog$_captured_this_1 = _analysis_server_dialog$_captured_this_1;
      this.$deferredAction();
    }
    AnalysisServerDialog_showDialog_closure0.builtin$cls = "AnalysisServerDialog_showDialog_closure0";
    if (!"name" in AnalysisServerDialog_showDialog_closure0)
      AnalysisServerDialog_showDialog_closure0.name = "AnalysisServerDialog_showDialog_closure0";
    $desc = $collectedClasses$.AnalysisServerDialog_showDialog_closure0[1];
    AnalysisServerDialog_showDialog_closure0.prototype = $desc;
    AnalysisServerDialog_showDialog_closure0.$__fields__ = ["_analysis_server_dialog$_captured_this_1"];
    function AnalysisServerDialog_showDialog_closure1(_analysis_server_dialog$_captured_this_2) {
      this._analysis_server_dialog$_captured_this_2 = _analysis_server_dialog$_captured_this_2;
      this.$deferredAction();
    }
    AnalysisServerDialog_showDialog_closure1.builtin$cls = "AnalysisServerDialog_showDialog_closure1";
    if (!"name" in AnalysisServerDialog_showDialog_closure1)
      AnalysisServerDialog_showDialog_closure1.name = "AnalysisServerDialog_showDialog_closure1";
    $desc = $collectedClasses$.AnalysisServerDialog_showDialog_closure1[1];
    AnalysisServerDialog_showDialog_closure1.prototype = $desc;
    AnalysisServerDialog_showDialog_closure1.$__fields__ = ["_analysis_server_dialog$_captured_this_2"];
    function Server(sdk, isSetup, isSettingUp, _isBusy, analysisComplete, _onServerStatus, _busyController, _analysis_server_impl$_allMessagesController, completionResults, _onCompletionResults, _analysis_server_impl$_process, _processCompleter, _pendingCommands, _nextId) {
      this.sdk = sdk;
      this.isSetup = isSetup;
      this.isSettingUp = isSettingUp;
      this._isBusy = _isBusy;
      this.analysisComplete = analysisComplete;
      this._onServerStatus = _onServerStatus;
      this._busyController = _busyController;
      this._analysis_server_impl$_allMessagesController = _analysis_server_impl$_allMessagesController;
      this.completionResults = completionResults;
      this._onCompletionResults = _onCompletionResults;
      this._analysis_server_impl$_process = _analysis_server_impl$_process;
      this._processCompleter = _processCompleter;
      this._pendingCommands = _pendingCommands;
    ...
    Server.$__fields__ = ["sdk", "isSetup", "isSettingUp", "_isBusy", "analysisComplete", "_onServerStatus", "_busyController", "_analysis_server_impl$_allMessagesController", "completionResults", "_onCompletionResults", "_analysis_server_impl$_process", "_processCompleter", "_pendingCommands", "_nextId"];
    Server.prototype.get$sdk = function() {
      return this.sdk;
    };
    function Server_listenToOutput_closure(_analysis_server_impl$_captured_this_0) {
      this._analysis_server_impl$_captured_this_0 = _analysis_server_impl$_captured_this_0;
      this.$deferredAction();
    }
    Server_listenToOutput_closure.builtin$cls = "Server_listenToOutput_closure";
    if (!"name" in Server_listenToOutput_closure)
      Server_listenToOutput_closure.name = "Server_listenToOutput_closure";
    $desc = $collectedClasses$.Server_listenToOutput_closure[1];
    Server_listenToOutput_closure.prototype = $desc;
    Server_listenToOutput_closure.$__fields__ = ["_analysis_server_impl$_captured_this_0"];
    function Server_listenToOutput_closure0(_analysis_server_impl$_captured_this_1) {
      this._analysis_server_impl$_captured_this_1 = _analysis_server_impl$_captured_this_1;
      this.$deferredAction();
    }
    Server_listenToOutput_closure0.builtin$cls = "Server_listenToOutput_closure0";
    if (!"name" in Server_listenToOutput_closure0)
      Server_listenToOutput_closure0.name = "Server_listenToOutput_closure0";
    $desc = $collectedClasses$.Server_listenToOutput_closure0[1];
    Server_listenToOutput_closure0.prototype = $desc;
    Server_listenToOutput_closure0.$__fields__ = ["_analysis_server_impl$_captured_this_1"];
    function Server_analysis_getErrors_closure() {
      this.$deferredAction();
    }
    Server_analysis_getErrors_closure.builtin$cls = "Server_analysis_getErrors_closure";
    if (!"name" in Server_analysis_getErrors_closure)
      Server_analysis_getErrors_closure.name = "Server_analysis_getErrors_closure";
    $desc = $collectedClasses$.Server_analysis_getErrors_closure[1];
    Server_analysis_getErrors_closure.prototype = $desc;
    Server_analysis_getErrors_closure.$__fields__ = [];
    function Server_analysis_getHover_closure() {
      this.$deferredAction();
    }
    Server_analysis_getHover_closure.builtin$cls = "Server_analysis_getHover_closure";
    if (!"name" in Server_analysis_getHover_closure)
      Server_analysis_getHover_closure.name = "Server_analysis_getHover_closure";
    $desc = $collectedClasses$.Server_analysis_getHover_closure[1];
    Server_analysis_getHover_closure.prototype = $desc;
    Server_analysis_getHover_closure.$__fields__ = [];
    function Server_start_closure(_analysis_server_impl$_captured_this_0) {
      this._analysis_server_impl$_captured_this_0 = _analysis_server_impl$_captured_this_0;
      this.$deferredAction();
    }
    Server_start_closure.builtin$cls = "Server_start_closure";
    if (!"name" in Server_start_closure)
      Server_start_closure.name = "Server_start_closure";
    $desc = $collectedClasses$.Server_start_closure[1];
    Server_start_closure.prototype = $desc;
    Server_start_closure.$__fields__ = ["_analysis_server_impl$_captured_this_0"];
    function Server_dispatchNotification_closure(_analysis_server_impl$_captured_this_0, _captured_event_1) {
      this._analysis_server_impl$_captured_this_0 = _analysis_server_impl$_captured_this_0;
      this._captured_event_1 = _captured_event_1;
      this.$deferredAction();
    }
    Server_dispatchNotification_closure.builtin$cls = "Server_dispatchNotification_closure";
    if (!"name" in Server_dispatchNotification_closure)
      Server_dispatchNotification_closure.name = "Server_dispatchNotification_closure";
    $desc = $collectedClasses$.Server_dispatchNotification_closure[1];
    Server_dispatchNotification_closure.prototype = $desc;
    Server_dispatchNotification_closure.$__fields__ = ["_analysis_server_impl$_captured_this_0", "_captured_event_1"];
    ...
    function AnalysisErrorsResult(errors) {
      this.errors = errors;
      this.$deferredAction();
    }
    AnalysisErrorsResult.builtin$cls = "AnalysisErrorsResult";
    if (!"name" in AnalysisErrorsResult)
      AnalysisErrorsResult.name = "AnalysisErrorsResult";
    $desc = $collectedClasses$.AnalysisErrorsResult[1];
    AnalysisErrorsResult.prototype = $desc;
    AnalysisErrorsResult.$__fields__ = ["errors"];
    AnalysisErrorsResult.prototype.get$errors = function() {
      return this.errors;
    };
    function AnalysisErrorsResult$from_closure() {
      this.$deferredAction();
    }
    AnalysisErrorsResult$from_closure.builtin$cls = "AnalysisErrorsResult$from_closure";
    if (!"name" in AnalysisErrorsResult$from_closure)
      AnalysisErrorsResult$from_closure.name = "AnalysisErrorsResult$from_closure";
    $desc = $collectedClasses$.AnalysisErrorsResult$from_closure[1];
    AnalysisErrorsResult$from_closure.prototype = $desc;
    AnalysisErrorsResult$from_closure.$__fields__ = [];
    ...
    function HoverResult$from_closure() {
      this.$deferredAction();
    }
    HoverResult$from_closure.builtin$cls = "HoverResult$from_closure";
    if (!"name" in HoverResult$from_closure)
      HoverResult$from_closure.name = "HoverResult$from_closure";
    $desc = $collectedClasses$.HoverResult$from_closure[1];
    HoverResult$from_closure.prototype = $desc;
    HoverResult$from_closure.$__fields__ = [];
    ...
    function AnalysisError(severity, type, message, correction, location) {
    ...
    AnalysisError.$__fields__ = ["severity", "type", "message", "correction", "location"];
    ...
    function JobManager__exec_closure1(_captured_this_5, _captured_job_6) {
      this._captured_this_5 = _captured_this_5;
      this._captured_job_6 = _captured_job_6;
      this.$deferredAction();
    }
    ...
    JobManager__exec_closure1.$__fields__ = ["_captured_this_5", "_captured_job_6"];
    function JobInstance(jobs, job, _running) {
      this.jobs = jobs;
      this.job = job;
    ...
    JobInstance.$__fields__ = ["jobs", "job", "_running"];
    ...
    function LinterProvider_registerLinterProvider_closure(_captured_provider_0) {
      this._captured_provider_0 = _captured_provider_0;
      this.$deferredAction();
    }
    LinterProvider_registerLinterProvider_closure.builtin$cls = "LinterProvider_registerLinterProvider_closure";
    if (!"name" in LinterProvider_registerLinterProvider_closure)
      LinterProvider_registerLinterProvider_closure.name = "LinterProvider_registerLinterProvider_closure";
    $desc = $collectedClasses$.LinterProvider_registerLinterProvider_closure[1];
    LinterProvider_registerLinterProvider_closure.prototype = $desc;
    LinterProvider_registerLinterProvider_closure.$__fields__ = ["_captured_provider_0"];
    function LinterProvider__lint_closure() {
      this.$deferredAction();
    }
    LinterProvider__lint_closure.builtin$cls = "LinterProvider__lint_closure";
    if (!"name" in LinterProvider__lint_closure)
      LinterProvider__lint_closure.name = "LinterProvider__lint_closure";
    $desc = $collectedClasses$.LinterProvider__lint_closure[1];
    LinterProvider__lint_closure.prototype = $desc;
    LinterProvider__lint_closure.$__fields__ = [];
    function LinterProvider__lint__closure() {
      this.$deferredAction();
    }
    LinterProvider__lint__closure.builtin$cls = "LinterProvider__lint__closure";
    if (!"name" in LinterProvider__lint__closure)
      LinterProvider__lint__closure.name = "LinterProvider__lint__closure";
    $desc = $collectedClasses$.LinterProvider__lint__closure[1];
    LinterProvider__lint__closure.prototype = $desc;
    LinterProvider__lint__closure.$__fields__ = [];
    ...
    function ProcessRunner_execStreaming_closure0(_captured_this_1) {
    ...
    ProcessRunner_execStreaming_closure0.$__fields__ = ["_captured_this_1"];
    ...
    function ProjectManager(_projects$_controller, _sub, projects) {
    ...
    ProjectManager.$__fields__ = ["_projects$_controller", "_sub", "projects"];
    ...
    function ProjectManager__checkForNewRemovedProjects_closure() {
      this.$deferredAction();
    }
    ProjectManager__checkForNewRemovedProjects_closure.builtin$cls = "ProjectManager__checkForNewRemovedProjects_closure";
    if (!"name" in ProjectManager__checkForNewRemovedProjects_closure)
      ProjectManager__checkForNewRemovedProjects_closure.name = "ProjectManager__checkForNewRemovedProjects_closure";
    $desc = $collectedClasses$.ProjectManager__checkForNewRemovedProjects_closure[1];
    ProjectManager__checkForNewRemovedProjects_closure.prototype = $desc;
    ProjectManager__checkForNewRemovedProjects_closure.$__fields__ = [];
    function ProjectManager__handleRemovedDirs_closure(_projects$_box_0, _projects$_captured_this_1) {
      this._projects$_box_0 = _projects$_box_0;
      this._projects$_captured_this_1 = _projects$_captured_this_1;
      this.$deferredAction();
    }
    ProjectManager__handleRemovedDirs_closure.builtin$cls = "ProjectManager__handleRemovedDirs_closure";
    if (!"name" in ProjectManager__handleRemovedDirs_closure)
      ProjectManager__handleRemovedDirs_closure.name = "ProjectManager__handleRemovedDirs_closure";
    $desc = $collectedClasses$.ProjectManager__handleRemovedDirs_closure[1];
    ProjectManager__handleRemovedDirs_closure.prototype = $desc;
    ProjectManager__handleRemovedDirs_closure.$__fields__ = ["_projects$_box_0", "_projects$_captured_this_1"];
    function ProjectManager__handleAddedDirs_closure(_projects$_captured_this_0) {
      this._projects$_captured_this_0 = _projects$_captured_this_0;
      this.$deferredAction();
    }
    ProjectManager__handleAddedDirs_closure.builtin$cls = "ProjectManager__handleAddedDirs_closure";
    if (!"name" in ProjectManager__handleAddedDirs_closure)
      ProjectManager__handleAddedDirs_closure.name = "ProjectManager__handleAddedDirs_closure";
    $desc = $collectedClasses$.ProjectManager__handleAddedDirs_closure[1];
    ProjectManager__handleAddedDirs_closure.prototype = $desc;
    ProjectManager__handleAddedDirs_closure.$__fields__ = ["_projects$_captured_this_0"];
    function ProjectManager__handleAddedDirs__closure(_projects$_captured_this_1) {
      this._projects$_captured_this_1 = _projects$_captured_this_1;
      this.$deferredAction();
    }
    ProjectManager__handleAddedDirs__closure.builtin$cls = "ProjectManager__handleAddedDirs__closure";
    if (!"name" in ProjectManager__handleAddedDirs__closure)
      ProjectManager__handleAddedDirs__closure.name = "ProjectManager__handleAddedDirs__closure";
    $desc = $collectedClasses$.ProjectManager__handleAddedDirs__closure[1];
    ProjectManager__handleAddedDirs__closure.prototype = $desc;
    ProjectManager__handleAddedDirs__closure.$__fields__ = ["_projects$_captured_this_1"];
    ...
    function smokeTest_closure1(_captured_childFile_0) {
      this._captured_childFile_0 = _captured_childFile_0;
      this.$deferredAction();
    }
    ...
    smokeTest_closure1.$__fields__ = ["_captured_childFile_0"];
    ...
    function smokeTest_closure5(_captured_panel_1) {
      this._captured_panel_1 = _captured_panel_1;
      this.$deferredAction();
    }
    ...
    smokeTest_closure5.$__fields__ = ["_captured_panel_1"];
    ...
    function StatusDisplay(_status$_disposables, _status$_subscription, _statusbarTile, _timer, _jobsPanel, _jobsPanelElement) {
    ...
    StatusDisplay.$__fields__ = ["_status$_disposables", "_status$_subscription", "_statusbarTile", "_timer", "_jobsPanel", "_jobsPanelElement"];
    ...
    function StatusDisplay_closure0(_status$_captured_this_1, _captured_statusElement_2, _captured_spinner_3, _captured_textLabel_4) {
    ...
    StatusDisplay_closure0.$__fields__ = ["_status$_captured_this_1", "_captured_statusElement_2", "_captured_spinner_3", "_captured_textLabel_4"];
    ...
    StatusDisplay_closure1.$__fields__ = ["_captured_this_7"];
    function StatusDisplay_closure2(_captured_this_8) {
      this._captured_this_8 = _captured_this_8;
      this.$deferredAction();
    }
    StatusDisplay_closure2.builtin$cls = "StatusDisplay_closure2";
    if (!"name" in StatusDisplay_closure2)
      StatusDisplay_closure2.name = "StatusDisplay_closure2";
    $desc = $collectedClasses$.StatusDisplay_closure2[1];
    StatusDisplay_closure2.prototype = $desc;
    StatusDisplay_closure2.$__fields__ = ["_captured_this_8"];
    ...
    function StatusDisplay__updateJobsDialog_closure(_captured_job_0) {
      this._captured_job_0 = _captured_job_0;
      this.$deferredAction();
    }
    StatusDisplay__updateJobsDialog_closure.builtin$cls = "StatusDisplay__updateJobsDialog_closure";
    if (!"name" in StatusDisplay__updateJobsDialog_closure)
      StatusDisplay__updateJobsDialog_closure.name = "StatusDisplay__updateJobsDialog_closure";
    $desc = $collectedClasses$.StatusDisplay__updateJobsDialog_closure[1];
    StatusDisplay__updateJobsDialog_closure.prototype = $desc;
    StatusDisplay__updateJobsDialog_closure.$__fields__ = ["_captured_job_0"];
    ...
    function Disposables(_disposables) {
    ...
    Disposables.$__fields__ = ["_disposables"];
    ...
    function _AsyncRun__scheduleImmediateJsOverride_internalCallback(_async$_captured_callback_0) {
      this._async$_captured_callback_0 = _async$_captured_callback_0;
      this.$deferredAction();
    }
    ...
    _AsyncRun__scheduleImmediateJsOverride_internalCallback.$__fields__ = ["_async$_captured_callback_0"];
    function _AsyncRun__scheduleImmediateWithSetImmediate_internalCallback(_async$_captured_callback_0) {
      this._async$_captured_callback_0 = _async$_captured_callback_0;
      this.$deferredAction();
    }
    ...
    _AsyncRun__scheduleImmediateWithSetImmediate_internalCallback.$__fields__ = ["_async$_captured_callback_0"];
    ...
    function ServerSetSubscriptionsParams(_protocol$_subscriptions) {
      this._protocol$_subscriptions = _protocol$_subscriptions;
      this.$deferredAction();
    }
    ServerSetSubscriptionsParams.builtin$cls = "ServerSetSubscriptionsParams";
    if (!"name" in ServerSetSubscriptionsParams)
      ServerSetSubscriptionsParams.name = "ServerSetSubscriptionsParams";
    $desc = $collectedClasses$.ServerSetSubscriptionsParams[1];
    ServerSetSubscriptionsParams.prototype = $desc;
    ServerSetSubscriptionsParams.$__fields__ = ["_protocol$_subscriptions"];
    function ServerSetSubscriptionsParams_toJson_closure() {
      this.$deferredAction();
    }
    ServerSetSubscriptionsParams_toJson_closure.builtin$cls = "ServerSetSubscriptionsParams_toJson_closure";
    if (!"name" in ServerSetSubscriptionsParams_toJson_closure)
      ServerSetSubscriptionsParams_toJson_closure.name = "ServerSetSubscriptionsParams_toJson_closure";
    $desc = $collectedClasses$.ServerSetSubscriptionsParams_toJson_closure[1];
    ServerSetSubscriptionsParams_toJson_closure.prototype = $desc;
    ServerSetSubscriptionsParams_toJson_closure.$__fields__ = [];
    function ServerSetSubscriptionsParams_operator$eq_closure() {
      this.$deferredAction();
    }
    ServerSetSubscriptionsParams_operator$eq_closure.builtin$cls = "ServerSetSubscriptionsParams_operator$eq_closure";
    if (!"name" in ServerSetSubscriptionsParams_operator$eq_closure)
      ServerSetSubscriptionsParams_operator$eq_closure.name = "ServerSetSubscriptionsParams_operator$eq_closure";
    $desc = $collectedClasses$.ServerSetSubscriptionsParams_operator$eq_closure[1];
    ServerSetSubscriptionsParams_operator$eq_closure.prototype = $desc;
    ServerSetSubscriptionsParams_operator$eq_closure.$__fields__ = [];
    function AnalysisSetAnalysisRootsParams(_included, _excluded, _packageRoots) {
      this._included = _included;
      this._excluded = _excluded;
      this._packageRoots = _packageRoots;
      this.$deferredAction();
    }
    AnalysisSetAnalysisRootsParams.builtin$cls = "AnalysisSetAnalysisRootsParams";
    if (!"name" in AnalysisSetAnalysisRootsParams)
      AnalysisSetAnalysisRootsParams.name = "AnalysisSetAnalysisRootsParams";
    $desc = $collectedClasses$.AnalysisSetAnalysisRootsParams[1];
    AnalysisSetAnalysisRootsParams.prototype = $desc;
    AnalysisSetAnalysisRootsParams.$__fields__ = ["_included", "_excluded", "_packageRoots"];
    function AnalysisSetAnalysisRootsParams_operator$eq_closure() {
      this.$deferredAction();
    }
    AnalysisSetAnalysisRootsParams_operator$eq_closure.builtin$cls = "AnalysisSetAnalysisRootsParams_operator$eq_closure";
    if (!"name" in AnalysisSetAnalysisRootsParams_operator$eq_closure)
      AnalysisSetAnalysisRootsParams_operator$eq_closure.name = "AnalysisSetAnalysisRootsParams_operator$eq_closure";
    $desc = $collectedClasses$.AnalysisSetAnalysisRootsParams_operator$eq_closure[1];
    AnalysisSetAnalysisRootsParams_operator$eq_closure.prototype = $desc;
    AnalysisSetAnalysisRootsParams_operator$eq_closure.$__fields__ = [];
    function AnalysisSetAnalysisRootsParams_operator$eq_closure0() {
      this.$deferredAction();
    }
    AnalysisSetAnalysisRootsParams_operator$eq_closure0.builtin$cls = "AnalysisSetAnalysisRootsParams_operator$eq_closure0";
    if (!"name" in AnalysisSetAnalysisRootsParams_operator$eq_closure0)
      AnalysisSetAnalysisRootsParams_operator$eq_closure0.name = "AnalysisSetAnalysisRootsParams_operator$eq_closure0";
    $desc = $collectedClasses$.AnalysisSetAnalysisRootsParams_operator$eq_closure0[1];
    AnalysisSetAnalysisRootsParams_operator$eq_closure0.prototype = $desc;
    AnalysisSetAnalysisRootsParams_operator$eq_closure0.$__fields__ = [];
    function AnalysisSetAnalysisRootsParams_operator$eq_closure1() {
      this.$deferredAction();
    }
    AnalysisSetAnalysisRootsParams_operator$eq_closure1.builtin$cls = "AnalysisSetAnalysisRootsParams_operator$eq_closure1";
    if (!"name" in AnalysisSetAnalysisRootsParams_operator$eq_closure1)
      AnalysisSetAnalysisRootsParams_operator$eq_closure1.name = "AnalysisSetAnalysisRootsParams_operator$eq_closure1";
    $desc = $collectedClasses$.AnalysisSetAnalysisRootsParams_operator$eq_closure1[1];
    AnalysisSetAnalysisRootsParams_operator$eq_closure1.prototype = $desc;
    AnalysisSetAnalysisRootsParams_operator$eq_closure1.$__fields__ = [];
    function ServerService(name) {
      this.name = name;
      this.$deferredAction();
    }
    ServerService.builtin$cls = "ServerService";
    if (!"name" in ServerService)
      ServerService.name = "ServerService";
    $desc = $collectedClasses$.ServerService[1];
    ServerService.prototype = $desc;
    ServerService.$__fields__ = ["name"];
    ServerService.prototype.get$name = function(receiver) {
      return this.name;
    };
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    registerPackage: function($package) {
      ...
      $._package.toString;
      t1.$indexSet(exports, "config", K.jsify(P.LinkedHashMap__makeLiteral(["sdkLocation", P.LinkedHashMap__makeLiteral(["title", "Dart SDK Location", "description", "The location of the Dart SDK.", "type", "string", "default", ""])])));
    ...
    AtomPackage: {
      ...
      }, "call$0", "get$serialize", 0, 0, 7]
    },
    registerPackage_closure: {
      "^": "Closure:8;_captured_exports_0",
    ...
    registerPackage__closure: {
      ...
      call$1: [function(arg) {
        var result = this._captured_f_1.call$1(arg);
        if (!!J.getInterceptor(result).$isDisposable)
    ...
    Workspace: {
      ...
      getTextEditors$0: function() {
        return J.map$1$ax(this.invoke$1("getTextEditors"), new E.Workspace_getTextEditors_closure()).toList$0(0);
      },
    ...
    CommandRegistry_add_closure: {
      "^": "Closure:2;_captured_callback_0",
      call$1: [function(e) {
        return this._captured_callback_0.call$1(new E.AtomEvent(E._cvt(e)));
      }, null, null, 2, 0, null, 3, "call"]
    },
    Config: {
      "^": "ProxyHolder;obj",
    ...
    Project: {
      ...
      getDirectories$0: function() {
        return J.map$1$ax(this.invoke$1("getDirectories"), new E.Project_getDirectories_closure()).toList$0(0);
      },
    ...
    Directory: {
      ...
      getEntriesSync$0: function() {
        return J.map$1$ax(this.invoke$1("getEntriesSync"), new E.Directory_getEntriesSync_closure()).toList$0(0);
      },
  ...
  }], ["atom.analysis_server", "package:atom_dart_lang_experimental/analysis_server.dart",, X, {
    "^": "",
    AnalysisServer: {
      "^": "Object;subs,disposables,_serverActiveController,_serverBusyController,_allMessagesController,_server,_job,knownRoots",
      ...
      get$onAllMessages: function() {
        var t1 = this._allMessagesController;
        return H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      },
      _setup$0: [function() {
        var t1, t2, t3, t4;
        $.get$_logger3().fine$1("setup()");
        ...
        t2.push(t1._workspace.observeTextEditors$1(this.get$_handleNewEditor()));
        t3 = X.Dependencies_instance().getDependency$1(C.Type_61i).get$projects();
        this.knownRoots = H.setRuntimeTypeInfo(t3.slice(), [H.getTypeArgumentByIndex(t3, 0)]);
        this._checkTrigger$0();
        t3 = X.Dependencies_instance();
        t4 = S.AnalysisServerDialog$();
        t3._instances.$indexSet(0, C.Type_tsp, t4);
        t2.push(t4);
        t2.push(t1._commands.add$3(0, "atom-text-editor", "dart-lang:dartdoc", new X.AnalysisServer__setup_closure(this)));
      ...
      get$isBusy: function() {
        var t1 = this._server;
        return t1 != null && t1._isBusy === true;
      },
      getErrors$1: function(filePath) {
        var t1 = this._server;
        if (t1 != null)
          return t1.analysis_getErrors$1(filePath);
        else {
          t1 = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
          t1._asyncComplete$1(new U.AnalysisErrorsResult([]));
          return t1;
        }
      },
      _syncRoots$0: function() {
        ...
        if (this._server != null) {
          roots = J.map$1$ax(this.knownRoots, new X.AnalysisServer__syncRoots_closure()).toList$0(0);
          t1 = this._server;
          t1.toString;
          t2 = new V.AnalysisSetAnalysisRootsParams(null, null, null);
          t2._included = roots;
          t2._excluded = [];
          t2._packageRoots = null;
          t1.send$2("analysis.setAnalysisRoots", t2.toJson$0());
        }
      },
      dispose$0: [function() {
      ...
      _reconcileRoots$1: [function(currentProjects) {
        var oldSet, currentSet, addedProjects, removedProjects, editors, t1, addedProject, t2, t3, _i, editor;
        oldSet = P.LinkedHashSet_LinkedHashSet$from(this.knownRoots, null);
        ...
        this.knownRoots = currentProjects;
        if (removedProjects._collection$_length !== 0 || addedProjects._collection$_length !== 0)
          this._syncRoots$0();
        if (addedProjects._collection$_length !== 0) {
          editors = J.toList$0$ax($.get$atom0()._workspace.getTextEditors$0());
          for (t1 = new P.LinkedHashSetIterator(addedProjects, addedProjects._collection$_modifications, null, null), t1._collection$_cell = addedProjects._collection$_first; t1.moveNext$0();) {
            addedProject = t1._collection$_current;
            for (t2 = editors.length, t3 = J.getInterceptor$asx(addedProject), _i = 0; _i < editors.length; editors.length === t2 || (0, H.throwConcurrentModificationError)(editors), ++_i) {
              editor = editors[_i];
              if (t3.contains$1(addedProject, editor.getPath$0()) === true)
                this._handleNewEditor$1(editor);
            }
          }
        }
        this._checkTrigger$0();
      }, "call$1", "get$_reconcileRoots", 2, 0, 10, 21],
      _handleSdkChange$1: [function(newSdk) {
        this._checkTrigger$0();
      }, "call$1", "get$_handleSdkChange", 2, 0, 11, 22],
      _handleNewEditor$1: [function(editor) {
        var path, project;
        path = editor.getPath$0();
        $.Zone__current.toString;
        project = $.Dependencies__global.getDependency$1(C.Type_61i).getProjectFor$1(path);
        if (project == null)
          return;
        if (!project.isDartFile$1(path))
          return;
        editor.get$onDidStopChanging()._createSubscription$4(new X.AnalysisServer__handleNewEditor_closure(this, editor, path), null, null, false);
        editor.get$onDidDestroy().listen$1(new X.AnalysisServer__handleNewEditor_closure0(this, path));
      }, "call$1", "get$_handleNewEditor", 2, 0, 12],
      start$0: [function(_) {
        var server;
        if (!X.Dependencies_instance().getDependency$1(C.Type_KEX).get$hasSdk())
          return;
        if (this._server == null) {
          server = U.Server$(X.Dependencies_instance().getDependency$1(C.Type_KEX).get$sdk());
          this._server = server;
      ...
      _checkTrigger$1$dispose: function(dispose) {
        ...
        shouldBeRunning = J.get$isNotEmpty$asx(this.knownRoots) === true && X.Dependencies_instance().getDependency$1(C.Type_KEX).get$hasSdk();
        if (!dispose)
        ...
        if (t1)
          this._server.kill$0();
        else if (shouldBeRunning && this._server == null) {
          server = U.Server$(X.Dependencies_instance().getDependency$1(C.Type_KEX).get$sdk());
          this._server = server;
          this._initNewServer$1(server);
        }
      ...
      _initNewServer$1: function(server) {
        ...
        server._processCompleter.future.then$1(new X.AnalysisServer__initNewServer_closure0(this, server));
        t1 = server._analysis_server_impl$_allMessagesController;
        ...
        server.setup$0().then$1(new X.AnalysisServer__initNewServer_closure3(this));
      },
      $isDisposable: 1
    },
    AnalysisServer__setup_closure: {
      ...
      call$1: function($event) {
        ...
        t1._server.analysis_getHover$2(editor.invoke$1("getPath"), offset).then$1(new X.AnalysisServer__setup__closure(true));
      }
    },
    AnalysisServer__setup__closure: {
      "^": "Closure:13;_captured_explicit_1",
      call$1: [function(result) {
        var hover, t1;
        ...
        t1.invoke$3("addInfo", J.title$0$x(hover), t1._options$3$detail$dismissable$icon(hover.render$0(), true, null));
      }, null, null, 2, 0, null, 14, "call"]
    },
    ...
    AnalysisServer__handleNewEditor_closure: {
      ...
      call$1: [function(_) {
        this._captured_editor_1.getText$0();
        $.get$_logger3().finer$1("notifyFileChanged(): " + H.S(this._captured_path_2));
        if (this._analysis_server$_captured_this_0._server != null)
          ;
        return;
    ...
    AnalysisServer__handleNewEditor_closure0: {
      ...
      call$1: [function(_) {
        $.get$_logger3().finer$1("notifyFileChanged(): " + H.S(this._captured_path_4));
        if (this._analysis_server$_captured_this_3._server != null)
          ;
        return;
      }, null, null, 2, 0, null, 23, "call"]
    },
    ...
    AnalysisServer__initNewServer_closure1: {
      ...
      call$1: [function(message) {
        var t1 = this._analysis_server$_captured_this_3._allMessagesController;
        if (!t1.get$_mayAddEvent())
          H.throwExpression(t1._addEventError$0());
    ...
    AnalysisServer__initNewServer_closure2: {
      ...
      call$1: [function(busy) {
        var t1, t2;
        t1 = busy === true;
        if (!t1 && this._analysis_server$_captured_this_4._job != null) {
          t1 = this._analysis_server$_captured_this_4;
          t2 = t1._job.completer;
          if (t2.future._state === 0)
            t2.complete$0(0);
          t1._job = null;
        } else if (t1 && this._analysis_server$_captured_this_4._job == null) {
          t1 = X._AnalyzingJob$();
          t1.start$0(0);
          this._analysis_server$_captured_this_4._job = t1;
        }
    ...
    AnalysisServer__initNewServer_closure3: {
      ...
      call$1: [function(_) {
        var t1, t2;
        t1 = this._analysis_server$_captured_this_5;
        t2 = t1._serverActiveController;
        if (!t2.get$_mayAddEvent())
          H.throwExpression(t2._addEventError$0());
        t2._sendData$1(true);
    ...
    _AnalyzingJob: {
      ...
      start$0: [function(_) {
        P.Timer_Timer(C.Duration_150000, new X._AnalyzingJob_start_closure(this));
      }, null, "get$start", 0, 0, null],
      _AnalyzingJob$0: function() {
        this._infoAction = new X._AnalyzingJob_closure();
      },
      infoAction$0: function() {
        return this.get$infoAction().call$0();
      },
    ...
    _DartLinterProvider: {
      "^": "LinterProvider;_severityMap,grammarScopes,scope,lintOnFly",
      lint$1: function(editor) {
        var filePath = editor.invoke$1("getPath");
        return X.Dependencies_instance().getDependency$1(C.Type_goj).getErrors$1(filePath).then$1(new X._DartLinterProvider_lint_closure(this, filePath)).catchError$1(new X._DartLinterProvider_lint_closure0());
      }
    },
    _DartLinterProvider_lint_closure: {
      "^": "Closure:14;_analysis_server$_captured_this_0,_captured_filePath_1",
      call$1: [function(result) {
        var t1 = J.where$1$ax(result.get$errors(), new X._DartLinterProvider_lint__closure());
        t1 = H.MappedIterable_MappedIterable(t1, new X._DartLinterProvider_lint__closure0(this._analysis_server$_captured_this_0, this._captured_filePath_1), H.getRuntimeTypeArgument(t1, "Iterable", 0), null);
        return P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "Iterable", 0));
      }, null, null, 2, 0, null, 14, "call"]
    },
    _DartLinterProvider_lint__closure: {
      "^": "Closure:15;",
      call$1: function(error) {
        return J.$eq(error.get$severity(), "WARNING") || J.$eq(error.get$severity(), "ERROR");
      }
    },
    _DartLinterProvider_lint__closure0: {
      "^": "Closure:2;_analysis_server$_captured_this_2,_captured_filePath_3",
      call$1: [function(e) {
        var t1, t2, t3;
        t1 = this._analysis_server$_captured_this_2._severityMap.$index(0, e.get$severity());
    ...
    AnalysisServerDialog: {
      "^": "Object;_analysis_server_dialog$_disposables,_panel,_messageElement,_statusElement,_startButton,_stopButton",
      dispose$0: [function() {
        this._analysis_server_dialog$_disposables.dispose$0();
        var t1 = this._panel;
        if (t1 != null)
          t1.invoke$1("destroy");
      }, "call$0", "get$dispose", 0, 0, 1],
      showDialog$0: function() {
        var t1, mainElement, title, t2, buttonGroup, t3;
        t1 = this._panel;
        if (t1 != null) {
          t1.invoke$1("show");
          return;
        }
        mainElement = document.createElement("div", null);
        t1 = J.getInterceptor$x(mainElement);
        t1.get$classes(mainElement).add$1(0, "analysis-dialog");
        title = document.createElement("div", null);
        t2 = J.getInterceptor$x(title);
        t2.get$classes(title).add$1(0, "message");
        t2.get$classes(title).add$1(0, "title");
        t2.get$classes(title).add$1(0, "text-highlight");
        title.textContent = "Analysis Server";
        t1.get$children(mainElement).add$1(0, title);
        buttonGroup = document.createElement("div", null);
        t2 = J.getInterceptor$x(buttonGroup);
        t2.get$classes(buttonGroup).add$1(0, "block");
        buttonGroup.setAttribute("layout", "");
        buttonGroup.setAttribute("horizontal", "");
        t1.get$children(mainElement).add$1(0, buttonGroup);
        t3 = document.createElement("div", null);
        t3.textContent = "Status:";
        this._statusElement = t3;
        J.get$classes$x(t3).add$1(0, "inline-block-tight");
        this._statusElement.setAttribute("flex", "");
        t2.get$children(buttonGroup).add$1(0, this._statusElement);
        t3 = W._ElementFactoryProvider_createElement_tag("button", null);
        J.get$classes$x(t3).addAll$1(0, ["btn", "btn-sm", "inline-block-tight"]);
        this._startButton = t3;
        J.set$text$x(t3, "Start");
        t3 = J.get$onClick$x(this._startButton);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(new S.AnalysisServerDialog_showDialog_closure(this)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
        t2.get$children(buttonGroup).add$1(0, this._startButton);
        t3 = W._ElementFactoryProvider_createElement_tag("button", null);
        J.get$classes$x(t3).addAll$1(0, ["btn", "btn-sm", "inline-block-tight"]);
        this._stopButton = t3;
        J.set$text$x(t3, "Shutdown");
        t3 = J.get$onClick$x(this._stopButton);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(new S.AnalysisServerDialog_showDialog_closure0(this)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
        t2.get$children(buttonGroup).add$1(0, this._stopButton);
        t2 = document.createElement("div", null);
        t3 = J.getInterceptor$x(t2);
        t3.get$classes(t2).add$1(0, "last-message");
        t3.get$classes(t2).add$1(0, "text-subtle");
        this._messageElement = t2;
        t1.get$children(mainElement).add$1(0, this._messageElement);
        t1 = $.get$atom0()._workspace;
        t1 = new E.Panel(t1.invoke$2("addModalPanel", t1._panelOptions$3(mainElement, null, null)));
        this._panel = t1;
        t1.get$onDidDestroy()._createSubscription$4(new S.AnalysisServerDialog_showDialog_closure1(this), null, null, false);
      ...
      _updateStatus$0: function() {
        ...
        if (X.Dependencies_instance().getDependency$1(C.Type_goj).get$isBusy() === true)
          this._statusElement.textContent = "Status: analyzing\u2026";
        else {
          t1 = X.Dependencies_instance().getDependency$1(C.Type_goj).get$isActive();
          t2 = this._statusElement;
          if (t1)
            t2.textContent = "Status: idle";
          else
            t2.textContent = "Status: process not running";
        }
        t1 = X.Dependencies_instance().getDependency$1(C.Type_goj).get$isActive();
        t2 = this._startButton;
        if (t1) {
          J.setAttribute$2$x(t2, "disabled", "");
          J.get$attributes$x(this._stopButton).remove$1(0, "disabled");
        } else {
          J.get$attributes$x(t2).remove$1(0, "disabled");
          J.setAttribute$2$x(this._stopButton, "disabled", "");
        }
      },
      AnalysisServerDialog$0: function() {
        var t1, t2;
        t1 = $.get$atom0();
        t2 = this._analysis_server_dialog$_disposables._disposables;
        t2.push(t1._commands.add$3(0, "atom-workspace", "dart-lang:analysis-server-status", new S.AnalysisServerDialog_closure(this)));
        t2.push(t1._commands.add$3(0, "atom-text-editor", "core:cancel", new S.AnalysisServerDialog_closure0(this)));
        ...
        X.Dependencies_instance().getDependency$1(C.Type_goj).get$onAllMessages().listen$1(new S.AnalysisServerDialog_closure3(this));
      },
      $isDisposable: 1,
    ...
    AnalysisServerDialog_closure3: {
      "^": "Closure:2;_captured_this_4",
      call$1: [function(message) {
        var t1, t2;
        t1 = this._captured_this_4;
        t2 = t1._messageElement;
        if (t2 != null && t1._panel != null)
          t2.textContent = H.S(message);
      }, null, null, 2, 0, null, 26, "call"]
    },
    ...
    AnalysisServerDialog_showDialog_closure1: {
      "^": "Closure:2;_analysis_server_dialog$_captured_this_2",
      call$1: [function(_) {
        this._analysis_server_dialog$_captured_this_2._panel = null;
      }, null, null, 2, 0, null, 23, "call"]
    }
  }], ["atom.analysis_server_impl", "package:atom_dart_lang_experimental/impl/analysis_server_impl.dart",, U, {
    "^": "",
    _renderMarkdownToText: function(str) {
    ...
    Server: {
      "^": "Object;sdk<,isSetup,isSettingUp,_isBusy,analysisComplete,_onServerStatus,_busyController,_analysis_server_impl$_allMessagesController,completionResults,_onCompletionResults,_analysis_server_impl$_process,_processCompleter,_pendingCommands,_nextId",
      get$onBusy: function() {
        var t1 = this._busyController;
        return H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      },
      get$onAllMessages: function() {
        var t1 = this._analysis_server_impl$_allMessagesController;
        return H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      },
      get$isBusy: function() {
        return this._isBusy;
      ...
      setup$0: function() {
        ...
        function setup$0(errorCode, result) {
          if (errorCode === 1) {
            currentError = result;
            $goto = handler;
          }
          while (true)
            switch ($goto) {
              case 0:
                // Function start
                t1 = $.get$_logger4();
                t1.fine$1("Setup starting");
                $self.isSettingUp = true;
                t1.fine$1("Server about to start");
                $goto = 2;
                return H.asyncHelper($self.start$0(0), setup$0, completer);
              case 2:
                // returning from await.
                t1.fine$1("Server started");
                $self.listenToOutput$0();
                t1.fine$1("listenToOutput returned");
                t2 = new V.ServerSetSubscriptionsParams(null);
                t2._protocol$_subscriptions = [C.ServerService_STATUS];
                $self.send$2("server.setSubscriptions", t2.toJson$0());
                t1.fine$1("set subscriptions completed");
                $self.isSettingUp = false;
                $self.isSetup = true;
                t1.fine$1("Setup done");
                // implicit return
        ...
        return H.asyncHelper(null, setup$0, completer, null);
      },
      kill$0: function() {
        var t1, t2;
        t1 = $.get$_logger4();
        ...
        this.isSetup = false;
        t2 = this._analysis_server_impl$_process;
        if (t2 != null) {
          t2._process.invoke$1("kill");
          t2._exitCompleter;
          this._analysis_server_impl$_process = null;
      ...
      listenToOutput$0: function() {
        var t1 = this._analysis_server_impl$_process._stdoutController;
        H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new U.Server_listenToOutput_closure(this));
        t1 = this._analysis_server_impl$_process._stderrController;
        H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new U.Server_listenToOutput_closure0(this));
      },
      analysis_getErrors$1: function(file) {
        return this.send$2("analysis.getErrors", P.LinkedHashMap__makeLiteral(["file", file])).then$1(new U.Server_analysis_getErrors_closure());
      },
      analysis_getHover$2: function(file, offset) {
        return this.send$2("analysis.getHover", P.LinkedHashMap__makeLiteral(["file", file, "offset", offset])).then$1(new U.Server_analysis_getHover_closure());
      },
      _processMessage$1: function(message) {
        var t1, id, completer, t2;
        t1 = J.getInterceptor$asx(message);
        if (message.containsKey$1("id") === true) {
          id = t1.$index(message, "id");
          completer = this._pendingCommands.remove$1(0, id);
          if (completer == null) {
            $.get$_logger4().severe$1("Unexpected response from server: id=" + H.S(id));
            return;
          }
          if (message.containsKey$1("error") === true) {
            t1 = t1.$index(message, "error");
            t2 = J.getInterceptor$asx(t1);
            completer.completeError$1(new U.RequestError(t2.$index(t1, "code"), t2.$index(t1, "message"), t2.$index(t1, "stackTrace")));
          } else
            J.complete$1$x(completer, t1.$index(message, "result"));
        } else
          this.dispatchNotification$2(t1.$index(message, "event"), t1.$index(message, "params"));
      },
      send$2: function(method, params) {
        var id, command, completer, line, t1, t2, t3;
        id = "" + this._nextId++;
        command = P.LinkedHashMap_LinkedHashMap$_literal(["id", id, "method", method], P.String, null);
        ...
        this._pendingCommands.$indexSet(0, id, completer);
        line = C.JsonCodec_null_null.encode$1(command);
        $.get$_logger4().finer$1("--> " + line);
        t1 = this._analysis_server_impl$_allMessagesController;
        if (!t1.get$_mayAddEvent())
          H.throwExpression(t1._addEventError$0());
        t1._sendData$1(line);
        t1 = this._analysis_server_impl$_process;
        t2 = line + "\n";
        t1 = t1._process;
        t3 = t1._stdin;
        if (t3 == null) {
      ...
      start$0: [function(_) {
        var t1, t2, t3;
        if (this._analysis_server_impl$_process != null)
          throw H.wrapException(P.Exception_Exception("Process already started"));
        t1 = this.sdk;
        t2 = t1.directory;
        t3 = J.$index$asx(E._create("File", G.join(t2, "bin", "snapshots", "analysis_server.dart.snapshot"), null), "path");
        t2 = J.$index$asx(t2.obj, "path");
        t2 = new Z.ProcessRunner(J.$index$asx(t1.get$dartVm().obj, "path"), [t3, "--sdk", t2], null, null, null, H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]), null, P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null));
        this._analysis_server_impl$_process = t2;
        t2.execStreaming$0().then$1(new U.Server_start_closure(this));
        t2 = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
        t2._asyncComplete$1(null);
        return t2;
      }, null, "get$start", 0, 0, null],
      dispatchNotification$2: function($event, params) {
        var t1, t2, t3;
        t1 = J.getInterceptor($event);
        if (t1.$eq($event, "server.error"))
          this.kill$0().then$1(new U.Server_dispatchNotification_closure(this, $event));
        if (t1.$eq($event, "server.status") && params.containsKey$1("analysis") === true && J.$index$asx(J.$index$asx(params, "analysis"), "isAnalyzing") !== true) {
          t2 = this._onServerStatus;
          if (t2._state >= 4)
            H.throwExpression(t2._badEventState$0());
          t2._add$1(true);
        }
        if (t1.$eq($event, "server.status") && params.containsKey$1("analysis") === true) {
          t2 = J.$index$asx(J.$index$asx(params, "analysis"), "isAnalyzing");
          this._isBusy = t2;
          t3 = this._busyController;
          if (!t3.get$_mayAddEvent())
            H.throwExpression(t3._addEventError$0());
          t3._sendData$1(t2);
        }
        if (t1.$eq($event, "completion.results") && J.$index$asx(params, "isLast") === true) {
          t1 = this._onCompletionResults;
          if (t1._state >= 4)
            H.throwExpression(t1._badEventState$0());
          t1._add$1(params);
        }
      },
      Server$1: function(sdk) {
        var t1 = P.StreamController_StreamController(null, null, null, null, true, P.bool);
        this._onServerStatus = t1;
        t1 = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]);
        this.analysisComplete = P._AsBroadcastStream$(t1, null, null, H.getRuntimeTypeArgument(t1, "Stream", 0));
        t1 = P.StreamController_StreamController(null, null, null, null, true, null);
        this._onCompletionResults = t1;
        t1 = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]);
        this.completionResults = P._AsBroadcastStream$(t1, null, null, H.getRuntimeTypeArgument(t1, "Stream", 0));
      },
      static: {Server$: function(sdk) {
          var t1 = new U.Server(sdk, false, false, false, null, null, P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null), null, null, null, H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]), P.LinkedHashMap__makeEmpty(), 0);
          t1.Server$1(sdk);
          return t1;
        }}
    },
    Server_listenToOutput_closure: {
      "^": "Closure:6;_analysis_server_impl$_captured_this_0",
      call$1: [function(str) {
        var line, message, lines, t1, t2, t3, _i, t4, exception;
        lines = J.trim$0$s(str).split("\n");
        for (t1 = lines.length, t2 = this._analysis_server_impl$_captured_this_0, t3 = t2._analysis_server_impl$_allMessagesController, _i = 0; _i < lines.length; lines.length === t1 || (0, H.throwConcurrentModificationError)(lines), ++_i) {
          line = lines[_i];
          ...
          try {
            ...
            H.unwrapException(exception);
            t4.severe$1("Bad data from server");
            continue;
          }
          t2._processMessage$1(message);
        }
      }, null, null, 2, 0, null, 29, "call"]
    },
    Server_listenToOutput_closure0: {
      "^": "Closure:6;_analysis_server_impl$_captured_this_1",
      call$1: [function(str) {
        var t1 = "ERR: " + J.trim$0$s(str);
        $.get$_logger4().fine$1(t1);
      }, null, null, 2, 0, null, 29, "call"]
    },
    Server_analysis_getErrors_closure: {
      "^": "Closure:16;",
      call$1: [function(result) {
        return U.AnalysisErrorsResult$from(result);
      }, null, null, 2, 0, null, 14, "call"]
    },
    Server_analysis_getHover_closure: {
      "^": "Closure:16;",
      call$1: [function(result) {
        return U.HoverResult$from(result);
      }, null, null, 2, 0, null, 14, "call"]
    },
    Server_start_closure: {
      "^": "Closure:17;_analysis_server_impl$_captured_this_0",
      call$1: [function(exitCode) {
        var t1;
        $.get$_logger4().fine$1("exited with code " + H.S(exitCode));
        t1 = this._analysis_server_impl$_captured_this_0._processCompleter;
        if (t1.future._state === 0)
          t1.complete$1(0, exitCode);
      }, null, null, 2, 0, null, 25, "call"]
    },
    Server_dispatchNotification_closure: {
      "^": "Closure:2;_analysis_server_impl$_captured_this_0,_captured_event_1",
      call$1: [function(_) {
        var t1, error, t2;
        t1 = this._analysis_server_impl$_captured_this_0._onCompletionResults;
        if (t1._state >= 4)
          H.throwExpression(t1._badEventState$0());
        ...
        $.get$_logger4().severe$1("Analysis server has crashed. " + H.S(this._captured_event_1));
      }, null, null, 2, 0, null, 23, "call"]
    },
    RequestError: {
      ...
      toString$0: function(_) {
        ...
        t2 = this.code;
        t3 = this.message;
        return t1 == null ? H.S(t2) + ": " + H.S(t3) : H.S(t2) + ": " + H.S(t3) + "\n" + H.S(t1);
      }
    },
    AnalysisErrorsResult: {
      "^": "Object;errors<",
      toString$0: function(_) {
        return H.S(this.errors);
      },
      static: {AnalysisErrorsResult$from: function(m) {
          var t1 = J.map$1$ax(J.$index$asx(m, "errors"), new U.AnalysisErrorsResult$from_closure()).toList$0(0);
          J.sort$0$ax(t1);
          return new U.AnalysisErrorsResult(t1);
        }}
    },
    AnalysisErrorsResult$from_closure: {
      "^": "Closure:2;",
      call$1: [function(obj) {
        var t1 = J.getInterceptor$asx(obj);
        return new U.AnalysisError(t1.$index(obj, "severity"), t1.$index(obj, "type"), t1.$index(obj, "message"), t1.$index(obj, "correction"), U.Location_Location$from(t1.$index(obj, "location")));
      }, null, null, 2, 0, null, 18, "call"]
    },
    HoverResult: {
      "^": "Object;hovers<",
      toString$0: function(_) {
        return J.toString$0(this.hovers);
      },
      static: {HoverResult$from: function(m) {
          return new U.HoverResult(J.map$1$ax(J.$index$asx(m, "hovers"), new U.HoverResult$from_closure()).toList$0(0));
        }}
    },
    HoverResult$from_closure: {
      "^": "Closure:2;",
      call$1: [function(obj) {
        var t1 = J.getInterceptor$asx(obj);
        return new U.HoverInformation(t1.$index(obj, "offset"), t1.$index(obj, "length"), t1.$index(obj, "containingLibraryPath"), t1.$index(obj, "containingLibraryName"), t1.$index(obj, "containingClassDescription"), t1.$index(obj, "dartdoc"), t1.$index(obj, "elementDescription"), t1.$index(obj, "elementKind"), t1.$index(obj, "parameter"), t1.$index(obj, "propagatedType"), t1.$index(obj, "staticType"));
      }, null, null, 2, 0, null, 18, "call"]
    },
    HoverInformation: {
      ...
      title$0: function(_) {
        var t1 = this.elementDescription;
        if (t1 != null)
          return t1;
        t1 = this.staticType;
        if (t1 != null)
          return t1;
        t1 = this.propagatedType;
        if (t1 != null)
          return t1;
        return "Dartdoc";
      },
      render$0: function() {
        var t1, t2;
        t1 = this.containingLibraryName;
        t1 = t1 != null ? "library: " + H.S(t1) + "\n" : "";
        t2 = this.containingClassDescription;
        if (t2 != null)
          t1 += "class: " + H.S(t2) + "\n";
        t2 = this.propagatedType;
        if (t2 != null)
          t1 += "propagated type: " + H.S(t2) + "\n";
        t2 = this.dartdoc;
        if (t2 != null)
          t1 += "\n" + H.S(U._renderMarkdownToText(t2)) + "\n";
        return t1.charCodeAt(0) == 0 ? t1 : t1;
      },
      toString$0: function(_) {
    ...
    AnalysisError: {
      "^": "Object;severity<,type,message>,correction,location>",
      compareTo$1: function(_, other) {
        var t1, t2;
        if (!(other instanceof U.AnalysisError))
          return 0;
        t1 = this.severity;
        t2 = other.severity;
        if (!J.$eq(t1, t2))
          return U.AnalysisError__sev(t2) - U.AnalysisError__sev(t1);
        return this.location.compareTo$1(0, other.location);
      },
      toString$0: function(_) {
        return H.S(this.severity) + ": " + H.S(this.message);
      },
      $isComparable: 1,
      $asComparable: functionThatReturnsNull,
      static: {AnalysisError__sev: function(sev) {
    ...
    Location: {
      ...
      compareTo$1: function(_, other) {
        var t1, t2, t3;
        if (!(other instanceof U.Location))
          return 0;
        t1 = this.file;
        t2 = other.file;
        ...
        return J.$sub$n(this.offset, other.offset);
      },
      toString$0: function(_) {
        return H.S(this.file) + "," + H.S(this.startLine) + "," + H.S(this.startColumn);
      },
      static: {Location_Location$from: function(m) {
          var t1;
          if (m == null)
            return;
          t1 = J.getInterceptor$asx(m);
          return new U.Location(t1.$index(m, "file"), t1.$index(m, "offset"), t1.$index(m, "length"), t1.$index(m, "startLine"), t1.$index(m, "startColumn"));
        }}
    }
  }], ["atom.editing", "package:atom_dart_lang_experimental/impl/editing.dart",, B, {
    "^": "",
    handleEnterKey: [function($event) {
      var editor, t1, selection, bufferRow, trimmedText, previousLine;
      editor = new E.TextEditor(E._cvt(new E.TextEditorView(E._cvt(J.$index$asx($event.obj, "currentTarget"))).invoke$1("getModel")));
      ...
      bufferRow = J.$index$asx(E._cvt(J.$index$asx(selection.obj, "start")), "row");
      trimmedText = J.trimLeft$0$s(editor.invoke$2("lineTextForBufferRow", bufferRow));
      if (C.JSString_methods.startsWith$1(trimmedText, "///")) {
        editor.invoke$1("insertNewline");
        editor.insertText$1("/// ");
        return;
      }
      if (C.JSString_methods.startsWith$1(trimmedText, "/*")) {
      ...
      if (C.JSString_methods.startsWith$1(trimmedText, "* ")) {
        t1 = J.getInterceptor$n(bufferRow);
        if (t1.$gt(bufferRow, 0)) {
          previousLine = J.trimLeft$0$s(editor.invoke$2("lineTextForBufferRow", t1.$sub(bufferRow, 1)));
      ...
      $event.invoke$1("abortKeyBinding");
    }, "call$1", "handleEnterKey$closure", 2, 0, 47]
  }], ["atom.elements", "package:atom_dart_lang_experimental/elements.dart",, K, {
    "^": "",
    CoreElement: {
      "^": "Object;element",
    ...
    JobManager: {
      ...
      _enqueue$1: function(job) {
        var t1, t2;
        $.get$_logger0().fine$1("scheduling job " + job.name);
      ...
      _exec$1: function(jobInstance) {
        ...
        $.get$_logger0().fine$1("starting job " + job.name);
    ...
    JobManager__exec_closure1: {
      "^": "Closure:2;_captured_this_5,_captured_job_6",
      call$1: [function(e) {
        var t1 = this._captured_this_5._toasts;
        t1.invoke$3("addError", this._captured_job_6.name + " failed.", t1._options$3$detail$dismissable$icon(H.S(e), true, null));
      }, null, null, 2, 0, null, 3, "call"]
    },
    JobInstance: {
      "^": "Object;jobs,job<,_running?",
      get$name: function(_) {
  ...
  }], ["atom.js", "package:atom_dart_lang_experimental/js.dart",, K, {
    "^": "",
    jsify: function(obj) {
      var t1;
      if (obj == null)
    ...
    Promise__jsObjectFromFuture_closure: {
      "^": "Closure:8;_js0$_captured_future_0",
  ...
  }], ["atom.linter", "package:atom_dart_lang_experimental/atom_linter.dart",, E, {
    "^": "",
    LinterProvider_registerLinterProvider: function(methodName, provider) {
      J.$indexSet$ax(J.$index$asx(J.$index$asx($.get$context(), "module"), "exports"), methodName, new E.LinterProvider_registerLinterProvider_closure(provider));
    },
    LinterProvider: {
      "^": "Object;",
      _lint$1: [function(jsEditor) {
        return K.Promise__jsObjectFromFuture(this.lint$1(new E.TextEditor(E._cvt(jsEditor))).then$1(new E.LinterProvider__lint_closure()));
      }, "call$1", "get$_lint", 2, 0, 20, 35]
    },
    LinterProvider_registerLinterProvider_closure: {
      "^": "Closure:0;_captured_provider_0",
      call$0: [function() {
        var t1 = this._captured_provider_0;
        return K.jsify(P.LinkedHashMap__makeLiteral(["grammarScopes", t1.grammarScopes, "scope", t1.scope, "lintOnFly", t1.lintOnFly, "lint", t1.get$_lint()]));
      }, null, null, 0, 0, null, "call"]
    },
    LinterProvider__lint_closure: {
      "^": "Closure:2;",
      call$1: [function(lints) {
        return J.map$1$ax(lints, new E.LinterProvider__lint__closure()).toList$0(0);
      }, null, null, 2, 0, null, 36, "call"]
    },
    LinterProvider__lint__closure: {
      "^": "Closure:2;",
      call$1: [function(lint) {
        return lint._toProxy$0();
  ...
  }], ["atom.plugin", "package:atom_dart_lang_experimental/plugin.dart",, R, {
    "^": "",
    AtomDartPackage: {
      ...
      packageActivated$1: [function(state) {
        ...
        t1.push(t3);
        t3 = X.Dependencies_instance();
        t2 = new X.AnalysisServer(new G.StreamSubscriptions([]), new G.Disposables([]), P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null), null, null, []);
        E.LinterProvider_registerLinterProvider("provideLinter", new X._DartLinterProvider(P.LinkedHashMap__makeLiteral(["ERROR", "Error", "WARNING", "Warning"]), ["source.dart"], "file", false));
        P.Timer_Timer(C.Duration_0, t2.get$_setup());
        t3._instances.$indexSet(0, C.Type_goj, t2);
        t1.push(t2);
        t2 = $.get$atom0();
        t1.push(t2._commands.add$3(0, "atom-workspace", "dart-lang:smoke-test", new R.AtomDartPackage_packageActivated_closure()));
        t1.push(t2._commands.add$3(0, "atom-workspace", "dart-lang:rebuild-restart", new R.AtomDartPackage_packageActivated_closure0()));
        t1.push(t2._commands.add$3(0, "atom-workspace", "dart-lang:auto-locate-sdk", new R.AtomDartPackage_packageActivated_closure1()));
        t1.push(t2._commands.add$3(0, "atom-workspace", "dart-lang:refresh-dart-projects", new R.AtomDartPackage_packageActivated_closure2()));
        t1.push(t2._commands.add$3(0, "atom-text-editor", "dart-lang:newline", B.handleEnterKey$closure()));
        this._addSdkCmd$3("atom-text-editor", "dart-lang:pub-get", new R.AtomDartPackage_packageActivated_closure3());
        this._addSdkCmd$3("atom-text-editor", "dart-lang:pub-upgrade", new R.AtomDartPackage_packageActivated_closure4());
        this._addSdkCmd$3(".tree-view", "dart-lang:pub-get", new R.AtomDartPackage_packageActivated_closure5());
        this._addSdkCmd$3(".tree-view", "dart-lang:pub-upgrade", new R.AtomDartPackage_packageActivated_closure6());
      }, function() {
        return this.packageActivated$1(null);
      }, "packageActivated$0", "call$1", "call$0", "get$packageActivated", 0, 2, 21, 38, 39],
      ...
      _addSdkCmd$3: function(target, command, callback) {
        this.disposables._disposables.push($.get$atom0()._commands.add$3(0, target, command, new R.AtomDartPackage__addSdkCmd_closure(callback)));
      },
      _setupLogging$0: function() {
        this.disposables._disposables.push($.get$atom0()._config.observe$3("dart-lang.logging", null, new R.AtomDartPackage__setupLogging_closure()));
      },
      AtomDartPackage$0: function() {
        var t1 = this._registeredMethods;
        if (t1 == null)
          H.throwExpression(new P.StateError("method must be registered in the package ctor"));
        t1.$indexSet(0, "consumeStatusBar", new R.AtomDartPackage_closure());
      },
    ...
    AtomDartPackage_packageActivated_closure0: {
      "^": "Closure:2;",
      call$1: function(_) {
        $.get$jobs()._enqueue$1(new S.RebuildJob("Rebuilding dart-lang", C.Type_cWU));
      }
    },
    ...
    AtomDartPackage_packageActivated_closure2: {
      "^": "Closure:2;",
      call$1: function(_) {
        $.get$jobs()._enqueue$1(new L.ProjectScanJob("Refresh Dart project list", null));
      }
    },
    ...
    AtomDartPackage_packageActivated_closure4: {
      "^": "Closure:2;",
      call$1: function($event) {
        var t1 = new R.PubJob(G.dirname($event.get$editor().invoke$1("getPath")), "upgrade", null, "Pub upgrade", null);
        t1._locatePubspecDir$0();
        $.get$jobs()._enqueue$1(t1);
      }
    },
    AtomDartPackage_packageActivated_closure5: {
      "^": "Closure:22;",
      call$1: function($event) {
        var t1 = new R.PubJob(G.dirname($event.get$selectedFilePath()), "get", null, "Pub get", null);
        t1._locatePubspecDir$0();
        $.get$jobs()._enqueue$1(t1);
      }
    },
    AtomDartPackage_packageActivated_closure6: {
      "^": "Closure:2;",
      call$1: function($event) {
        var t1 = new R.PubJob(G.dirname($event.get$selectedFilePath()), "upgrade", null, "Pub upgrade", null);
        t1._locatePubspecDir$0();
        $.get$jobs()._enqueue$1(t1);
      }
    },
    ...
    ProcessRunner_execStreaming_closure0: {
      ...
      call$1: [function(s) {
        var t1 = this._captured_this_1._stderrController;
        if (!t1.get$_mayAddEvent())
          H.throwExpression(t1._addEventError$0());
        t1._sendData$1(s);
        return;
  ...
  }], ["atom.projects", "package:atom_dart_lang_experimental/projects.dart",, L, {
    "^": "",
    ProjectManager: {
      "^": "Object;_projects$_controller,_sub,projects<",
      ...
      }, "call$0", "get$rescanForProjects", 0, 0, 1],
      get$onChanged: function() {
        var t1 = this._projects$_controller;
        return H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      },
      dispose$0: [function() {
        $.get$_logger1().fine$1("dispose()");
        this._sub.cancel$0();
      }, "call$0", "get$dispose", 0, 0, 1],
      _fullScanForProjects$0: function() {
        ...
        if (newDirs._collection$_length !== 0)
          changed = true;
        C.JSArray_methods.addAll$1(t1, H.setRuntimeTypeInfo(new H.EfficientLengthMappedIterable(newDirs, new L.ProjectManager__fullScanForProjects_closure1()), [H.getTypeArgumentByIndex(newDirs, 0), null]));
        if (changed) {
          $.get$_logger1().fine$1(H.S(t1));
      ...
      _checkForNewRemovedProjects$0: function() {
        var previousDirs, currentDirs, removedDirs, addedDirs;
        previousDirs = P.LinkedHashSet_LinkedHashSet$from(H.setRuntimeTypeInfo(new H.MappedListIterable(this.projects, new L.ProjectManager__checkForNewRemovedProjects_closure()), [null, null]), null);
        currentDirs = P.LinkedHashSet_LinkedHashSet$from($.get$atom0()._project.getDirectories$0(), null);
        removedDirs = previousDirs.difference$1(currentDirs);
        addedDirs = currentDirs.difference$1(previousDirs);
        if (removedDirs._collection$_length !== 0)
          this._handleRemovedDirs$1(removedDirs.toList$0(0));
        if (addedDirs._collection$_length !== 0)
          this._handleAddedDirs$1(addedDirs.toList$0(0));
      },
      _handleRemovedDirs$1: function(dirs) {
        var t1, t2;
        t1 = {};
        t1._captured_removed_0 = false;
        C.JSArray_methods.forEach$1(dirs, new L.ProjectManager__handleRemovedDirs_closure(t1, this));
        if (t1._captured_removed_0) {
          t1 = this.projects;
          $.get$_logger1().fine$1(H.S(t1));
          t2 = this._projects$_controller;
          if (!t2.get$_mayAddEvent())
      ...
      _handleAddedDirs$1: function(dirs) {
        var t1, count, t2;
        t1 = this.projects;
        count = t1.length;
        C.JSArray_methods.forEach$1(dirs, new L.ProjectManager__handleAddedDirs_closure(this));
        if (count !== t1.length) {
          $.get$_logger1().fine$1(H.S(t1));
          t2 = this._projects$_controller;
          if (!t2.get$_mayAddEvent())
      ...
      ProjectManager$0: function() {
        this._sub = $.get$atom0()._project.eventStream$1("onDidChangePaths").listen$1(new L.ProjectManager_closure(this));
        P.Timer_Timer(C.Duration_0, this.get$rescanForProjects());
      },
      $isDisposable: 1,
      static: {ProjectManager_isDartProject: function(dir) {
          ...
          var t1 = new L.ProjectManager(P.StreamController_StreamController$broadcast(null, null, false, null), null, []);
          t1.ProjectManager$0();
          return t1;
        }}
    },
    ProjectManager_closure: {
      "^": "Closure:2;_projects$_captured_this_0",
      call$1: [function(_) {
        return this._projects$_captured_this_0._checkForNewRemovedProjects$0();
      }, null, null, 2, 0, null, 23, "call"]
    },
    ...
    ProjectManager__checkForNewRemovedProjects_closure: {
      "^": "Closure:2;",
      call$1: [function(p) {
        return J.get$directory$x(p);
      }, null, null, 2, 0, null, 42, "call"]
    },
    ProjectManager__handleRemovedDirs_closure: {
      "^": "Closure:24;_projects$_box_0,_projects$_captured_this_1",
      call$1: function(dir) {
        var t1, t2, t3, _i, project, t4;
        for (t1 = this._projects$_captured_this_1.projects, t2 = t1.length, t3 = J.getInterceptor(dir), _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          project = t1[_i];
          t4 = J.getInterceptor$x(project);
          if (t3.$eq(dir, t4.get$directory(project)) || t3.contains$1(dir, J.get$path$x(t4.get$directory(project))) === true) {
            C.JSArray_methods.remove$1(t1, project);
            this._projects$_box_0._captured_removed_0 = true;
            break;
          }
        }
      }
    },
    ProjectManager__handleAddedDirs_closure: {
      "^": "Closure:24;_projects$_captured_this_0",
      call$1: function(dir) {
        var t1 = this._projects$_captured_this_0;
        C.JSArray_methods.forEach$1(t1._findDartProjects$2(dir, 2), new L.ProjectManager__handleAddedDirs__closure(t1));
      }
    },
    ProjectManager__handleAddedDirs__closure: {
      "^": "Closure:2;_projects$_captured_this_1",
      call$1: function(dir) {
        this._projects$_captured_this_1.projects.push(new L.DartProject(dir));
      }
    },
    DartProject: {
      "^": "Object;directory>",
      ...
      isDartFile$1: function(path) {
        if (path == null)
          return false;
        return J.endsWith$1$s(path, ".dart");
      },
  ...
  }], ["atom.pub", "package:atom_dart_lang_experimental/impl/pub.dart",, R, {
    "^": "",
    PubJob: {
      ...
      _locatePubspecDir$0: function() {
        ...
        if (new E.File(E._create("File", G.join(t1, "pubspec.yaml", null, null), null)).invoke$1("existsSync") === true) {
          this._pubspecDir = J.$index$asx(t2, "path");
          return;
        }
        while (true) {
          if (!(dir.invoke$1("isRoot") !== true && J.$gt$n(J.get$length$asx(J.$index$asx(dir.obj, "path")), 2)))
            break;
  ...
  }], ["atom.sdk", "package:atom_dart_lang_experimental/sdk.dart",, V, {
    "^": "",
    SdkManager: {
      ...
      SdkManager$0: function() {
        ...
        t1 = $.get$atom0();
        t2 = t1._config;
        this._setSdkPath$1(t2.invoke$3("get", "dart-lang.sdkLocation", null));
        if (this._sdk == null)
          this.tryToAutoConfigure$1$complainOnFailure(false);
        this._prefObserve = t1._config.observe$3("dart-lang.sdkLocation", null, new V.SdkManager_closure(this));
      },
      $isDisposable: 1,
    ...
    SdkManager_tryToAutoConfigure_closure: {
      ...
      call$1: [function(sdkPath) {
        var t1;
        if (sdkPath != null)
          $.get$atom0()._config.invoke$3("set", "dart-lang.sdkLocation", sdkPath);
    ...
    Sdk: {
      ...
      get$dartVm: function() {
        ...
        if ($.get$isWindows() === true)
          return new E.File(E._create("File", G.join(t1, "bin", "dart.exe", null), null));
        else
          return new E.File(E._create("File", G.join(t1, "bin", "dart", null), null));
      },
  ...
  }], ["atom.smoketest", "package:atom_dart_lang_experimental/impl/smoketest.dart",, E, {
    "^": "",
    smokeTest: function() {
      var element, t1, t2, panel, dirs, dir, children, childFile, childDir, sdk, vm, projects;
      element = document.createElement("div", null);
      element.textContent = "Hello world.";
      t1 = $.get$atom0();
      t2 = t1._workspace;
      panel = new E.Panel(t2.invoke$2("addTopPanel", t2._panelOptions$3(element, true, null)));
      panel.get$onDidDestroy()._createSubscription$4(new E.smokeTest_closure(), null, null, false);
      dirs = t1._project.getDirectories$0();
      P.print("project directories = " + H.S(dirs));
      P.print("project.getPaths() = " + H.S(t1._project.invoke$1("getPaths")));
      dir = J.get$first$ax(dirs);
      E._printEntry(dir);
      E._printEntry(dir.getParent$0());
      children = dir.getEntriesSync$0();
      t2 = J.getInterceptor$ax(children);
      childFile = t2.firstWhere$1(children, new E.smokeTest_closure0());
      ...
      childDir = t2.firstWhere$1(children, new E.smokeTest_closure2());
      ...
      t2.invoke$3("addSuccess", "Hello world from dart-lang!", t2._options$3$detail$dismissable$icon(null, null, null));
      t2 = t1._notifications;
      t2.invoke$3("addInfo", "Hello world from dart-lang!", t2._options$3$detail$dismissable$icon("Foo bar.", null, null));
      t1 = t1._notifications;
      t1.invoke$3("addWarning", "Hello world from dart-lang!", t1._options$3$detail$dismissable$icon("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, null));
      ...
      t1 = $.get$jobs();
      t1._enqueue$1(new E._TestJob(1, null, "Lorem ipsum dolor", C.Type_gT2));
      t1._enqueue$1(new E._TestJob(2, null, "Sit amet consectetur", C.Type_gT2));
      t1._enqueue$1(new E._TestJob(3, new E.smokeTest_closure12(), "Adipiscing elit sed", C.Type_gT2));
      t1._enqueue$1(new E._TestJob(4, null, "Do eiusmod tempor", C.Type_gT2));
    ...
    smokeTest_closure5: {
      "^": "Closure:0;_captured_panel_1",
      call$0: function() {
        P.print("futures delayed");
        this._captured_panel_1.invoke$1("destroy");
      }
    },
    smokeTest_closure8: {
      "^": "Closure:2;",
  ...
  }], ["atom.state", "package:atom_dart_lang_experimental/state.dart",, K, {}], ["atom.status", "package:atom_dart_lang_experimental/impl/status_display.dart",, E, {
    "^": "",
    StatusDisplay: {
      "^": "Object;_status$_disposables,_status$_subscription,_statusbarTile,_timer,_jobsPanel,_jobsPanelElement",
      dispose$0: [function() {
      ...
      _updateJobsDialog$0: function() {
        var title, t1, ol, t2, t3, _i, jobInstance, job, t4, item, t5, t6, block, t7, t8, t9;
        ...
        t3 = t1.length;
        _i = 0;
        for (; _i < t1.length; t1.length === t3 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          jobInstance = t1[_i];
          job = jobInstance.get$job();
          t4 = W._ElementFactoryProvider_createElement_tag("li", null);
          item = new K.CoreElement(t4);
          t5 = J.getInterceptor$x(t4);
          t5.setAttribute$2(t4, "layout", "");
          t5.setAttribute$2(t4, "horizontal", "");
          if (C.JSString_methods.contains$1("job-container", " "))
            H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
          t5.get$classes(t4).add$1(0, "job-container");
          t5 = W._ElementFactoryProvider_createElement_tag("div", null);
          t6 = new K.CoreElement(t5);
          if (C.JSString_methods.contains$1("inline-block", " "))
            H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
          J.get$classes$x(t5).add$1(0, "inline-block");
          t6.toggleAttribute$2("flex", true);
          title = item.add$1(0, t6);
          t5 = job.name;
          if (jobInstance.get$isRunning())
            t5 += "\u2026";
          J.set$text$x(title.element, t5);
          if (jobInstance.get$isRunning()) {
            t5 = W._ElementFactoryProvider_createElement_tag("div", null);
            if (C.JSString_methods.contains$1("inline-block", " "))
              H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
            t6 = J.getInterceptor$x(t5);
            t6.get$classes(t5).add$1(0, "inline-block");
            if (C.JSString_methods.contains$1("jobs-progress", " "))
              H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
            t6.get$classes(t5).add$1(0, "jobs-progress");
            block = item.add$1(0, new K.CoreElement(t5));
            t5 = W._ElementFactoryProvider_createElement_tag("div", null);
            t6 = new K.ProgressElement(null, t5);
            if (C.JSString_methods.contains$1("block", " "))
              H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
            J.get$classes$x(t5).add$1(0, "block");
            t5 = W._ElementFactoryProvider_createElement_tag("progress", null);
            if (C.JSString_methods.contains$1("inline-block", " "))
              H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
            J.get$classes$x(t5).add$1(0, "inline-block");
            t6._progress = t6.add$1(0, new K.CoreElement(t5));
            block.add$1(0, t6);
          }
          if (job.get$infoAction() != null) {
            ...
            t6 = J.getInterceptor$x(t5);
            t6.get$classes(t5).add$1(0, "inline-block");
            if (C.JSString_methods.contains$1("info", " "))
              H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
            t6.get$classes(t5).add$1(0, "info");
            if (C.JSString_methods.contains$1("icon", " "))
              H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
            t6.get$classes(t5).add$1(0, "icon");
            if (C.JSString_methods.contains$1("icon-question", " "))
              H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
            t6.get$classes(t5).add$1(0, "icon-question");
            t5 = J.get$onClick$x(item.add$1(0, new K.CoreElement(t5)).element);
            t6 = t5._eventType;
            t7 = t5._useCapture;
            t8 = new W._EventStreamSubscription(0, t5._html$_target, t6, W._wrapZone(new E.StatusDisplay__updateJobsDialog_closure(job)), t7);
            t8.$builtinTypeInfo = [H.getTypeArgumentByIndex(t5, 0)];
            t5 = t8._html$_onData;
            t9 = t5 != null;
            if (t9 && t8._pauseCount <= 0) {
              t8 = t8._html$_target;
              t8.toString;
              if (t9)
                J._addEventListener$3$x(t8, t6, t5, t7);
            }
          }
          t2.get$children(ol).add$1(0, t4);
        }
      },
      StatusDisplay$1: function(statusBar) {
        ...
        m = P.LinkedHashMap__makeLiteral(["item", t1]);
        ...
        J.setAttribute$2$x(spinner.element, "src", "atom://dart-lang-experimental/images/gear.svg");
        ...
        this._status$_subscription = H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new E.StatusDisplay_closure0(this, statusElement, spinner, textLabel));
        t1 = $.get$atom0();
        t2 = this._status$_disposables._disposables;
        t2.push(t1._commands.add$3(0, "atom-text-editor", "core:cancel", new E.StatusDisplay_closure1(this)));
        t2.push(t1._commands.add$3(0, "atom-workspace", "dart-lang:show-jobs", new E.StatusDisplay_closure2(this)));
      },
      $isDisposable: 1,
      static: {StatusDisplay$: function(statusBar) {
          var t1 = new E.StatusDisplay(new G.Disposables([]), null, null, null, null, null);
    ...
    StatusDisplay_closure: {
      ...
      call$1: [function(_) {
        var t1 = this._status$_captured_this_0;
    ...
    StatusDisplay_closure0: {
      "^": "Closure:2;_status$_captured_this_1,_captured_statusElement_2,_captured_spinner_3,_captured_textLabel_4",
      call$1: [function(_) {
    ...
    StatusDisplay_closure1: {
      "^": "Closure:2;_captured_this_7",
      call$1: function(_) {
        var t1 = this._captured_this_7._jobsPanel;
        if (t1 != null)
          t1.invoke$1("hide");
      }
    },
    StatusDisplay_closure2: {
    ...
    StatusDisplay__updateJobsDialog_closure: {
      "^": "Closure:2;_captured_job_0",
      call$1: [function(_) {
        return this._captured_job_0.infoAction$0();
      }, null, null, 2, 0, null, 23, "call"]
    }
  ...
  }], ["atom.utils", "package:atom_dart_lang_experimental/utils.dart",, G, {
    "^": "",
  ...
  }], ["core.dependencies", "package:atom_dart_lang_experimental/dependencies.dart",, X, {
    "^": "",
    Dependencies: {
      "^": "Object;_instances",
    ...
    }, "call$1", "_AsyncRun__scheduleImmediateJsOverride$closure", 2, 0, 38],
    _AsyncRun__scheduleImmediateWithSetImmediate: [function(callback) {
      ++init.globalState.topEventLoop._activeJsAsyncCount;
      self.setImmediate(H.convertDartClosureToJS(new P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback(callback), 0));
    }, "call$1", "_AsyncRun__scheduleImmediateWithSetImmediate$closure", 2, 0, 38],
    _AsyncRun__scheduleImmediateWithTimer: [function(callback) {
      P.Timer__createTimer(C.Duration_0, callback);
    }, "call$1", "_AsyncRun__scheduleImmediateWithTimer$closure", 2, 0, 38],
    ...
    }, "call$1", "_nullDataHandler$closure", 2, 0, 39, 24],
    ...
    }, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 28, 38, 12, 13],
    ...
    _AsBroadcastStreamController: {
      ...
      }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 26, 38, 12, 13],
      close$0: [function(_) {
        var t1 = this._state;
        if ((t1 & 4) === 0 && (t1 & 2) !== 0) {
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 28, 38, 12, 13],
    ...
    _Future__chainForeignFuture_closure0: {
      "^": "Closure:29;_captured_target_1",
      call$2: [function(error, stackTrace) {
        this._captured_target_1._completeError$2(error, stackTrace);
      }, function(error) {
        return this.call$2(error, null);
      }, "call$1", null, null, null, 2, 2, null, 38, 12, 13, "call"]
    },
    _Future__chainForeignFuture_closure1: {
    ...
    _Future__propagateToListeners_handleWhenCompleteCallback_closure0: {
      "^": "Closure:29;_async$_box_0,_captured_result_12",
      call$2: [function(error, stackTrace) {
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 26, 38, 12, 13],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 31, 12, 13],
    ...
    _defaultEquals: [function(a, b) {
      return J.$eq(a, b);
    }, "call$2", "_defaultEquals$closure", 4, 0, 40],
    _defaultHashCode: [function(a) {
      return J.get$hashCode$(a);
    }, "call$1", "_defaultHashCode$closure", 2, 0, 41, 50],
    ...
    }, "call$1", "_defaultToEncodable$closure", 2, 0, 42, 1],
    _JsonMap: {
    ...
    _JsonStringifier_writeMap_closure: {
      "^": "Closure:8;_convert$_box_0,_captured_keyValueList_1",
    ...
    }, "call$2", "Comparable_compare$closure", 4, 0, 43],
    ...
    }, "call$2", "identical$closure", 4, 0, 44],
    identityHashCode: [function(object) {
      return H.objectHashCode(object);
    }, "call$1", "identityHashCode$closure", 2, 0, 45],
    ...
    NoSuchMethodError_toString_closure: {
      "^": "Closure:32;_box_0,_captured_sb_1",
      call$2: function(key, value) {
        var t1, t2, t3;
    ...
    Element: {
      ...
      title$0: function($receiver) {
        return $receiver.title.call$0();
      },
      $isElement: 1,
      $isNode: 1,
      $isObject: 1,
    ...
    HtmlDocument: {
      ...
      title$0: function($receiver) {
        return this.get$title($receiver).call$0();
      },
      "%": "HTMLDocument"
    },
    IFrameElement: {
    ...
    InputElement: {
      "^": "HtmlElement;name=,value=,directory:webkitdirectory=",
      $isElement: 1,
      $isInterceptor: 1,
      $isNode: 1,
      "%": "HTMLInputElement"
    ...
    }, null, null, 8, 0, null, 51, 52, 53, 54],
    ...
    }, "call$1", "_convertToJS$closure", 2, 0, 2, 55],
    ...
    }, "call$1", "_convertToDart$closure", 2, 0, 42, 55],
    ...
    CssClassSetImpl: {
      ...
      }, "call$1", "get$_validateToken", 2, 0, 34, 24],
      toString$0: function(_) {
  ...
  }], ["protocol", "package:dart_analysis_server_api/protocol.dart",, V, {
    "^": "",
    _listEqual: function(listA, listB, itemEqual) {
      var t1, t2, i;
      if (listA == null)
        return listB == null;
      if (listB == null)
        return false;
      t1 = J.getInterceptor$asx(listA);
      t2 = J.getInterceptor$asx(listB);
      if (t1.get$length(listA) !== t2.get$length(listB))
        return false;
      for (i = 0; i < t1.get$length(listA); ++i)
        if (itemEqual.call$2(t1.$index(listA, i), t2.$index(listB, i)) !== true)
          return false;
      return true;
    },
    _mapEqual: function(mapA, mapB, valueEqual) {
      return true;
    },
    ...
    ServerSetSubscriptionsParams: {
      "^": "Object;_protocol$_subscriptions",
      toJson$0: function() {
        var result, t1;
        result = P.LinkedHashMap__makeEmpty();
        t1 = this._protocol$_subscriptions;
        t1.toString;
        result.$indexSet(0, "subscriptions", H.setRuntimeTypeInfo(new H.MappedListIterable(t1, new V.ServerSetSubscriptionsParams_toJson_closure()), [null, null]).toList$0(0));
        return result;
      },
      toString$0: function(_) {
      ...
      $eq: function(_, other) {
        if (other == null)
          return false;
        if (other instanceof V.ServerSetSubscriptionsParams)
          return V._listEqual(this._protocol$_subscriptions, other._protocol$_subscriptions, new V.ServerSetSubscriptionsParams_operator$eq_closure());
        return false;
      },
      get$hashCode: function(_) {
        return V._JenkinsSmiHash_finish1(V._JenkinsSmiHash_combine1(0, J.get$hashCode$(this._protocol$_subscriptions)));
      }
    },
    ServerSetSubscriptionsParams_toJson_closure: {
      "^": "Closure:35;",
      call$1: [function(value) {
        return value.toJson$0();
      }, null, null, 2, 0, null, 24, "call"]
    },
    ServerSetSubscriptionsParams_operator$eq_closure: {
      "^": "Closure:36;",
      call$2: function(a, b) {
        return J.$eq(a, b);
      }
    ...
    AnalysisSetAnalysisRootsParams: {
      "^": "Object;_included,_excluded,_packageRoots",
      toJson$0: function() {
        var result = P.LinkedHashMap__makeEmpty();
        result.$indexSet(0, "included", this._included);
        result.$indexSet(0, "excluded", this._excluded);
        return result;
      },
      toString$0: function(_) {
        return C.JsonCodec_null_null.encode$1(this.toJson$0());
      ...
      $eq: function(_, other) {
        if (other == null)
          return false;
        if (other instanceof V.AnalysisSetAnalysisRootsParams)
          return V._listEqual(this._included, other._included, new V.AnalysisSetAnalysisRootsParams_operator$eq_closure()) && V._listEqual(this._excluded, other._excluded, new V.AnalysisSetAnalysisRootsParams_operator$eq_closure0()) && V._mapEqual(this._packageRoots, other._packageRoots, new V.AnalysisSetAnalysisRootsParams_operator$eq_closure1());
        return false;
      },
      get$hashCode: function(_) {
        return V._JenkinsSmiHash_finish1(V._JenkinsSmiHash_combine1(V._JenkinsSmiHash_combine1(V._JenkinsSmiHash_combine1(0, J.get$hashCode$(this._included)), J.get$hashCode$(this._excluded)), C.JSNull_methods.get$hashCode(this._packageRoots)));
      }
    },
    AnalysisSetAnalysisRootsParams_operator$eq_closure: {
      "^": "Closure:37;",
      call$2: function(a, b) {
        return J.$eq(a, b);
      }
    },
    AnalysisSetAnalysisRootsParams_operator$eq_closure0: {
      "^": "Closure:37;",
      call$2: function(a, b) {
        return J.$eq(a, b);
      }
    },
    AnalysisSetAnalysisRootsParams_operator$eq_closure1: {
      "^": "Closure:37;",
      call$2: function(a, b) {
        return false;
      }
  ...
  }], ["", "package:atom_dart_lang_experimental/impl/rebuild.dart",, S, {
    "^": "",
    RebuildJob: {
      "^": "Job;name,schedulingRule",
      run$0: function() {
        ...
        t1 = $.get$atom0();
        proj = J.firstWhere$2$orElse$ax(t1._project.getDirectories$0(), new S.RebuildJob_run_closure("atom-dartlang-experimental"), new S.RebuildJob_run_closure0());
        if (proj == null) {
          t1 = t1._notifications;
          t1.invoke$3("addWarning", "Unable to find project 'atom-dartlang-experimental'.", t1._options$3$detail$dismissable$icon(null, null, null));
          t1 = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
          t1._asyncComplete$1(null);
          return t1;
        }
        J.forEach$1$ax(t1._workspace.getTextEditors$0(), new S.RebuildJob_run_closure1());
        return X.Dependencies_instance().getDependency$1(C.Type_KEX).get$sdk().execBinSimple$3$cwd("dart2js", ["--csp", "-oweb/entry.dart.js", "--show-package-warnings", "web/entry.dart"], proj).then$1(new S.RebuildJob_run_closure2(proj));
      }
    },
    RebuildJob_run_closure: {
      "^": "Closure:2;_captured_projName_0",
      call$1: function(d) {
        return J.$eq(d.getBaseName$0(), this._captured_projName_0);
      }
    },
    ...
    RebuildJob_run_closure2: {
      "^": "Closure:23;_captured_proj_1",
      call$1: [function(result) {
        var file, t1;
        if (J.$eq(result.get$exit(), 0)) {
          file = new E.File(E._cvt(this._captured_proj_1.getSubdirectory$1("web").invoke$2("getFile", "entry.dart.js")));
          K.promiseToFuture(file.invoke$2("read", null)).then$1(new S.RebuildJob_run__closure(file));
        }
        if (result.get$stdout().length !== 0)
          ...
          return P.Future_Future$delayed(P.Duration$(0, 0, 0, 0, 0, 1), null, null).then$1(new S.RebuildJob_run__closure0());
        }
      }, null, null, 2, 0, null, 14, "call"]
    },
    RebuildJob_run__closure: {
  ...
  J.title$0$x = function(receiver) {
    return J.getInterceptor$x(receiver).title$0(receiver);
  };
...
;
  ...
  }, "separator", "_AsyncRun_scheduleImmediateClosure", "get$_AsyncRun_scheduleImmediateClosure", function() {
  ...
  $ = new Isolate();
  init.metadata = ["invocation", "object", "sender", "e", "x", "closure", "isolate", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "error", "stackTrace", "result", "each", "arg", "ed", "obj", "dir", "entry", "currentProjects", "newSdk", "_", "value", "exitCode", "message", "busy", "val", "str", "rec", "evt", "errorCallback", "resolve", "reject", "jsEditor", "lints", "lint", null, "state", "code", "s", "p", "sdkPath", "data", "contents", "ver", "foundSdk", "ignored", "element", "a", "callback", "captureThis", "self", "arguments", "o"];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Map}, {func: 1, args: [,,]}, {func: 1, ret: P.bool}, {func: 1, void: true, args: [[P.List, L.DartProject]]}, {func: 1, void: true, args: [V.Sdk]}, {func: 1, void: true, args: [E.TextEditor]}, {func: 1, args: [U.HoverResult]}, {func: 1, args: [U.AnalysisErrorsResult]}, {func: 1, args: [U.AnalysisError]}, {func: 1, args: [P.Map]}, {func: 1, args: [P.$int]}, {func: 1, args: [N.LogRecord]}, {func: 1, void: true, args: [{func: 1, void: true, args: [,]}]}, {func: 1, ret: P.JsObject, args: [,]}, {func: 1, void: true, opt: [P.Map]}, {func: 1, args: [E.AtomEvent]}, {func: 1, args: [Z.ProcessResult]}, {func: 1, args: [E.Directory]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.Future}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [P.bool]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, args: [V.ServerService]}, {func: 1, args: [V.ServerService, V.ServerService]}, {func: 1, args: [P.String, P.String]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,]}, {func: 1, ret: P.bool, args: [,,]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, ret: P.$int, args: [P.Comparable, P.Comparable]}, {func: 1, ret: P.bool, args: [P.Object, P.Object]}, {func: 1, ret: P.$int, args: [P.Object]}, {func: 1, void: true, args: [P.Object]}, {func: 1, void: true, args: [E.AtomEvent]}];
