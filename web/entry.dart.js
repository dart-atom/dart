...
["atom.analysis_server", "package:atom_dart/analysis_server.dart", , X, {
  "^": "",
  AnalysisServer: {
    "^": "Object;subs,disposables,_serverActiveController,_serverBusyController,_server,_job,knownRoots",
    ...
    _setup$0: [function() {
      ...
      this.disposables._utils$_disposables.push($.get$atom0()._workspace.observeTextEditors$1(this.get$_handleNewEditor()));
    ...
    _reconcileRoots$1: [function(currentProjects) {
      ...
      if (addedProjects._collection$_length !== 0) {
        ...
        for (t1 = new P.LinkedHashSetIterator(addedProjects, addedProjects._collection$_modifications, null, null), t1._cell = addedProjects._collection$_first; t1.moveNext$0();) {
    ...
    _checkTrigger$1$dispose: function(dispose) {
      ...
      if (t1)
        ...
        server = new U.Server(X.Dependencies_instance().getDependency$1(C.Type_KEX).get$sdk(), false, false, null, null, P.StreamController_StreamController$broadcast(null, null, false, null), null, null, null, H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]), P.LinkedHashMap_LinkedHashMap$_empty(null, null), 0);
        t1 = P.StreamController_StreamController(null, null, null, null, true, P.bool);
        server._onServerStatus = t1;
        t1 = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]);
        server.analysisComplete = P._AsBroadcastStream$(t1, null, null, H.getRuntimeTypeArgument(t1, "Stream", 0));
        t1 = P.StreamController_StreamController(null, null, null, null, true, null);
        server._onCompletionResults = t1;
        t1 = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]);
        server.completionResults = P._AsBroadcastStream$(t1, null, null, H.getRuntimeTypeArgument(t1, "Stream", 0));
        this._server = server;
    ...
    _initNewServer$1: function(server) {
      ...
      server.setup$0().then$1(new X.AnalysisServer__initNewServer_closure2(this));
    },
    $isDisposable: 1
  },
  ...
  AnalysisServer__handleNewEditor_closure: {
    ...
    call$1: [function(_) {
      ...
      $.get$_logger0().finer$1("notifyFileChanged(): " + H.S(this._captured_path_2));
  ...
  AnalysisServer__handleNewEditor_closure0: {
    "^": "Closure:2;_captured_this_3,_captured_path_4",
    call$1: [function(_) {
      $.get$_logger0().finer$1("notifyFileChanged(): " + H.S(this._captured_path_4));
      if (this._captured_this_3._server != null)
        ;
      return;
    }, null, null, 2, 0, null, 23, "call"]
  },
  ...
  AnalysisServer__initNewServer_closure1: {
    ...
    call$1: [function(busy) {
      var t1, t2;
      t1 = busy === true;
      if (!t1 && this._captured_this_3._job != null) {
        t1 = this._captured_this_3;
        t2 = t1._job.completer;
        if (t2.future._state === 0)
          t2.complete$0(0);
        t1._job = null;
      } else if (t1 && this._captured_this_3._job == null) {
        t1 = new X._AnalyzingJob(H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]), "Analyzing", null);
        t1.start$0(0);
        this._captured_this_3._job = t1;
      }
  ...
  _AnalyzingJob: {
    "^": "Job;completer,name,schedulingRule",
    get$quiet: function() {
      return true;
    },
    run$0: function() {
...
["atom.analysis_server_impl", "package:atom_dart/impl/analysis_server_impl.dart", , U, {
  "^": "",
  Server: {
    "^": "Object;sdk<,isSetup,isSettingUp,analysisComplete,_onServerStatus,_busyController,completionResults,_onCompletionResults,_process,_processCompleter,_pendingCommands,_nextId",
    get$onBusy: function() {
    ...
    listenToOutput$1: function(notificationProcessor) {
      ...
      new P.LineSplitter().bind$1(H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)])).listen$1(new U.Server_listenToOutput_closure(this, notificationProcessor));
      ...
      function dispatchNotification$2(errorCode, result) {
        ...
        while (true)
          switch ($goto) {
            ...
            case 5:
              // returning from await.
              $self._onCompletionResults.addError$1(null);
              $.get$_logger1().severe$1("Analysis server has crashed. " + H.S($event));
              // goto return
              $goto = 1;
              break;
            case 4:
              ...
              if (t1.$eq($event, "server.status") && params.containsKey$1("analysis") === true) {
                t2 = $self._busyController;
                t3 = J.$index$asx(J.$index$asx(params, "analysis"), "isAnalyzing");
                if (!t2.get$_mayAddEvent())
                  H.throwExpression(t2._addEventError$0());
                else
                  ;
  ...
  Server_listenToOutput_closure: {
    ...
    call$1: [function(line) {
      ...
      try {
        ...
        H.unwrapException(exception);
        t1.severe$1("Bad data from server");
        return;
      }
      messageAsMap = message;
      if (messageAsMap.containsKey$1("id") === true) {
        id = J.$index$asx(message, "id");
        t2 = this._analysis_server_impl$_captured_this_0;
        t3 = t2._pendingCommands;
        completer = t3.$index(0, id);
        if (completer == null)
          t1.fine$1("Unexpected response from server: id=" + H.S(id));
        else
          t3.remove$1(0, id);
        if (messageAsMap.containsKey$1("error") === true) {
          t2.kill$0();
          completer.completeError$1(new P.UnimplementedError("Server responded with an error: " + C.JsonCodec_null_null.encode$1(message)));
        } else
          completer.complete$1(0, J.$index$asx(messageAsMap, "result"));
      } else {
        t1 = J.getInterceptor$asx(messageAsMap);
        this._captured_notificationProcessor_1.call$2(t1.$index(messageAsMap, "event"), t1.$index(messageAsMap, "params"));
      }
...
["atom.editing", "package:atom_dart/impl/editing.dart", , B, {
  ...
  handleEnterKey: [function($event) {
    ...
    $event.invoke$1("abortKeyBinding");
  }, "call$1", "handleEnterKey$closure", 2, 0, 44]
}],
...
1],
["atom.jobs", "package:atom_dart/jobs.dart", , S, {
  "^": "",
  Job: {
  ...
  JobManager: {
    "^": "Object;_controller,_jobs,_toasts",
    ...
    _enqueue$1: function(job) {
      var t1, t2;
      $.get$_logger3().fine$1("scheduling job " + job.name);
    ...
    _exec$1: function(jobInstance) {
      ...
      $.get$_logger3().fine$1("starting job " + job.name);
  ...
  JobManager__exec_closure0: {
    ...
    call$0: [function() {
      ...
      $.get$_logger3().fine$1("finished job " + H.S(J.get$name$x(t2)));
...
["atom.plugin", "package:atom_dart/plugin.dart", , R, {
  ...
  AtomDartPackage: {
    ...
    packageActivated$1: [function(state) {
      ...
      t1 = this.disposables._utils$_disposables;
      t1.push(t2);
      ...
      t2 = new X.AnalysisServer(new G.StreamSubscriptions([]), new G.Disposables([]), P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null), null, null, []);
    ...
    }, "packageActivated$0", "call$1", "call$0", "get$packageActivated", 0, 2, 17, 32, 33],
    ...
    _addSdkCmd$3: function(target, command, callback) {
      this.disposables._utils$_disposables.push($.get$atom0()._commands.add$3(0, target, command, new R.AtomDartPackage__addSdkCmd_closure(callback)));
    },
    _setupLogging$0: function() {
      this.disposables._utils$_disposables.push($.get$atom0()._config.observe$3("dart-lang.logging", null, new R.AtomDartPackage__setupLogging_closure()));
    },
    AtomDartPackage$0: function() {
      var t1 = this._registeredMethods;
      if (t1 == null)
        H.throwExpression(P.StateError$("method must be registered in the package ctor"));
  ...
  AtomDartPackage_packageActivated_closure7: {
    "^": "Closure:2;",
    call$1: [function(val) {
      $.get$_logger().info$1("analysis server active: " + H.S(val));
    }, null, null, 2, 0, null, 34, "call"]
  },
  AtomDartPackage_packageActivated_closure8: {
    "^": "Closure:2;",
    call$1: [function(val) {
      $.get$_logger().info$1("analysis server busy: " + H.S(val));
    }, null, null, 2, 0, null, 34, "call"]
  },
...
["atom.projects", "package:atom_dart/projects.dart", , L, {
  ...
  ProjectManager: {
    ...
    _fullScanForProjects$0: function() {
      ...
      for (t2 = new P.LinkedHashSetIterator(previousDirs, previousDirs._collection$_modifications, null, null), t2._cell = previousDirs._collection$_first, changed = false; t2.moveNext$0();) {
...
["atom.smoketest", "package:atom_dart/impl/smoketest.dart", , E, {
  ...
  smokeTest: function() {
    ...
    t1 = $.get$jobs();
    t1._enqueue$1(new E._TestJob(1, "Lorem ipsum dolor", C.Type_gT2));
    t1._enqueue$1(new E._TestJob(2, "Sit amet consectetur", C.Type_gT2));
    t1._enqueue$1(new E._TestJob(3, "Adipiscing elit sed", C.Type_gT2));
    t1._enqueue$1(new E._TestJob(4, "Do eiusmod tempor", C.Type_gT2));
  ...
  _TestJob: {
    "^": "Job;seconds,name,schedulingRule",
    run$0: function() {
      return P.Future_Future$delayed(P.Duration$(0, 0, 0, 0, 0, this.seconds), null, null);
    }
  }
}],
["atom.status", "package:atom_dart/impl/status_display.dart", , E, {
  "^": "",
  StatusDisplay: {
    ...
    _updateJobsDialog$0: function() {
      ...
      for (; t1.moveNext$0();) {
        ...
        t4 = job.name;
        J.set$text$x(title, jobInstance.get$isRunning() ? t4 + "\u2026" : t4);
        if (jobInstance.get$isRunning()) {
          t4 = W._ElementFactoryProvider_createElement_tag("div", null);
          if (C.JSString_methods.contains$1("inline-block", " "))
            H.throwExpression(P.ArgumentError$("spaces not allowed in class names"));
    ...
    StatusDisplay$1: function(statusBar) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new E.StatusDisplay_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
...
["atom.utils", "package:atom_dart/utils.dart", , G, {
  ...
  Disposables: {
    "^": "Object;_utils$_disposables",
    add$1: function(_, disposable) {
      this._utils$_disposables.push(disposable);
    },
    dispose$0: [function() {
      var t1, t2;
      for (t1 = this._utils$_disposables, t2 = new J.ArrayIterator(t1, t1.length, 0, null); t2.moveNext$0();)
...
["dart.async", "dart:async", , P, {
  ...
  StreamIterator_StreamIterator: function(stream, $T) {
    ...
    t3 = t1.get$_onError();
    t1._async$_subscription = stream.listen$4$cancelOnError$onDone$onError(t2, true, t1.get$_onDone(), t3);
    return t1;
  },
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 24, 32, 12, 13],
  ...
  _AsBroadcastStreamController: {
    ...
    }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 22, 32, 12, 13],
    close$0: [function(_) {
      var t1 = this._state;
      if ((t1 & 4) === 0 && (t1 & 2) !== 0) {
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 24, 32, 12, 13],
  ...
  _Future__chainForeignFuture_closure0: {
    ...
    }, "call$1", null, null, null, 2, 2, null, 32, 12, 13, "call"]
  },
  ...
  _AsBroadcastStream: {
    "^": "Stream;_source,_onListenHandler,_onCancelHandler,_zone<,_async$_controller,_async$_subscription",
    listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
      var t1, t2, t3;
      ...
      if (this._async$_subscription == null) {
        t1 = t1.get$add(t1);
        t2 = this._async$_controller.get$addError();
        t3 = this._async$_controller;
        this._async$_subscription = this._source.listen$3$onDone$onError(t1, t3.get$close(t3), t2);
      }
  ...
  _StreamIteratorImpl: {
    "^": "Object;_async$_subscription,_async$_current,_futureOrPrefetch,_state",
    _clear$0: function() {
      this._async$_subscription = null;
    ...
    cancel$0: function() {
      ...
      subscription = this._async$_subscription;
    ...
    _async$_onData$1: [function(data) {
      ...
      this._async$_subscription.pause$0(0);
    ...
    }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 22, 32, 12, 13],
    _onDone$0: [function() {
      if (this._state === 2) {
  ...
  _ForwardingStreamSubscription: {
    "^": "_BufferingStreamSubscription;_stream,_async$_subscription,_async$_onData,_onError,_onDone,_zone,_state,_cancelFuture,_pending",
    _async$_add$1: function(data) {
      if ((this._state & 2) !== 0)
        return;
    ...
    _ForwardingStreamSubscription$5: function(_stream, onData, onError, onDone, cancelOnError, $S, $T) {
      ...
      this._async$_subscription = this._stream._source.listen$3$onDone$onError(t1, this.get$_handleDone(), t2);
    },
  ...
  _SinkTransformerStreamSubscription: {
    "^": "_BufferingStreamSubscription;_transformerSink,_async$_subscription,_async$_onData,_onError,_onDone,_zone,_state,_cancelFuture,_pending",
    _async$_add$1: function(data) {
      if ((this._state & 2) !== 0)
    ...
    }, "_handleError$1", "call$2", "call$1", "get$_handleError", 2, 2, 28, 32, 12, 13],
    _handleDone$0: [function() {
      var e, s, exception, t1;
      try {
        this._async$_subscription = null;
  ...
  _BoundSinkStream: {
    ...
    listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
      ...
      subscription._async$_subscription = this._stream.listen$3$onDone$onError(t1, subscription.get$_handleDone(), t2);
      return subscription;
    },
    listen$3$onDone$onError: function(onData, onDone, onError) {
      return this.listen$4$cancelOnError$onDone$onError(onData, null, onDone, onError);
...
["dart.collection", "dart:collection", , P, {
  ...
  }, "call$1", "_defaultHashCode$closure", 2, 0, 39, 45],
...
["dart.convert", "dart:convert", , P, {
  ...
  Converter_bind_closure: {
    "^": "Closure:29;_convert$_captured_this_0",
  ...
  LineSplitter: {
    "^": "Converter;",
    startChunkedConversion$1: function(sink) {
      return new P._LineSplitterSink(new P._StringAdapterSink(sink), null);
    }
  },
  _LineSplitterSink: {
    "^": "StringConversionSinkBase;_sink,_carry",
    addSlice$4: function(chunk, start, end, isLast) {
      var t1, t2;
      t1 = this._carry;
      if (t1 != null) {
        t2 = J.substring$2$s(chunk, start, end);
        if (t1 == null)
          return t1.$add();
        chunk = t1 + t2;
        end = chunk.length;
      ...
      t1 = this._sink;
      this._carry = P._LineSplitterSink__addSlice(chunk, start, end, isLast, t1.get$add(t1));
      if (isLast) {
    ...
    static: {_LineSplitterSink__addSlice: function(chunk, start, end, isLast, adder) {
        var t1, t2, pos, $char, skip, t3, carry;
        if (typeof end !== "number")
          return H.iae(end);
        t1 = J.getInterceptor$s(chunk);
        t2 = !isLast;
        pos = start;
        for (; pos < end;) {
          ...
          if ($char === 10)
            ...
            t3 = pos + 1;
            if (t3 < end)
              skip = t1.codeUnitAt$1(chunk, t3) === 10 ? 2 : 1;
            else {
              if (t2)
...
["dart.core", "dart:core", , P, {
  ...
  }, "call$2", "identical$closure", 4, 0, 41],
  identityHashCode: [function(object) {
    return H.objectHashCode(object);
  }, "call$1", "identityHashCode$closure", 2, 0, 42],
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$1", "_convertToDart$closure", 2, 0, 40, 50],
...
init.precompiled = function($collectedClasses) {
  ...
  function LinkedHashMapKeyIterator(__js_helper$_map, _modifications, __js_helper$_cell, __js_helper$_current) {
    this.__js_helper$_map = __js_helper$_map;
    this._modifications = _modifications;
  ...
  LinkedHashMapKeyIterator.$__fields__ = ["__js_helper$_map", "_modifications", "__js_helper$_cell", "__js_helper$_current"];
  ...
  function AnalysisServer(subs, disposables, _serverActiveController, _serverBusyController, _server, _job, knownRoots) {
    this.subs = subs;
  ...
  AnalysisServer.$__fields__ = ["subs", "disposables", "_serverActiveController", "_serverBusyController", "_server", "_job", "knownRoots"];
  ...
  function AnalysisServer__handleNewEditor_closure0(_captured_this_3, _captured_path_4) {
  ...
  AnalysisServer__handleNewEditor_closure0.$__fields__ = ["_captured_this_3", "_captured_path_4"];
  ...
  function AnalysisServer__initNewServer_closure1(_captured_this_3) {
    this._captured_this_3 = _captured_this_3;
    this.$deferredAction();
  }
  ...
  AnalysisServer__initNewServer_closure1.$__fields__ = ["_captured_this_3"];
  ...
  function _AnalyzingJob(completer, name, schedulingRule) {
  ...
  _AnalyzingJob.$__fields__ = ["completer", "name", "schedulingRule"];
  ...
  function Server(sdk, isSetup, isSettingUp, analysisComplete, _onServerStatus, _busyController, completionResults, _onCompletionResults, _process, _processCompleter, _pendingCommands, _nextId) {
    this.sdk = sdk;
  ...
  Server.$__fields__ = ["sdk", "isSetup", "isSettingUp", "analysisComplete", "_onServerStatus", "_busyController", "completionResults", "_onCompletionResults", "_process", "_processCompleter", "_pendingCommands", "_nextId"];
  ...
  function JobManager(_controller, _jobs, _toasts) {
  ...
  JobManager.$__fields__ = ["_controller", "_jobs", "_toasts"];
  ...
  function _TestJob(seconds, name, schedulingRule) {
  ...
  function Disposables(_utils$_disposables) {
    this._utils$_disposables = _utils$_disposables;
    this.$deferredAction();
  }
  ...
  Disposables.$__fields__ = ["_utils$_disposables"];
  ...
  function _AsBroadcastStream(_source, _onListenHandler, _onCancelHandler, _zone, _async$_controller, _async$_subscription) {
    this._source = _source;
    this._onListenHandler = _onListenHandler;
    this._onCancelHandler = _onCancelHandler;
    this._zone = _zone;
    this._async$_controller = _async$_controller;
    this._async$_subscription = _async$_subscription;
    this.$deferredAction();
  }
  ...
  _AsBroadcastStream.$__fields__ = ["_source", "_onListenHandler", "_onCancelHandler", "_zone", "_async$_controller", "_async$_subscription"];
  ...
  function _StreamIteratorImpl(_async$_subscription, _async$_current, _futureOrPrefetch, _state) {
    this._async$_subscription = _async$_subscription;
  ...
  _StreamIteratorImpl.$__fields__ = ["_async$_subscription", "_async$_current", "_futureOrPrefetch", "_state"];
  ...
  function _ForwardingStreamSubscription(_stream, _async$_subscription, _async$_onData, _onError, _onDone, _zone, _state, _cancelFuture, _pending) {
    this._stream = _stream;
    this._async$_subscription = _async$_subscription;
    this._async$_onData = _async$_onData;
    this._onError = _onError;
  ...
  _ForwardingStreamSubscription.$__fields__ = ["_stream", "_async$_subscription", "_async$_onData", "_onError", "_onDone", "_zone", "_state", "_cancelFuture", "_pending"];
  ...
  function _SinkTransformerStreamSubscription(_transformerSink, _async$_subscription, _async$_onData, _onError, _onDone, _zone, _state, _cancelFuture, _pending) {
  ...
  _SinkTransformerStreamSubscription.$__fields__ = ["_transformerSink", "_async$_subscription", "_async$_onData", "_onError", "_onDone", "_zone", "_state", "_cancelFuture", "_pending"];
  ...
  function LinkedHashSetIterator(_set, _collection$_modifications, _cell, _collection$_current) {
    this._set = _set;
    this._collection$_modifications = _collection$_modifications;
    this._cell = _cell;
    this._collection$_current = _collection$_current;
  ...
  LinkedHashSetIterator.$__fields__ = ["_set", "_collection$_modifications", "_cell", "_collection$_current"];
  ...
  function _LineSplitterSink(_sink, _carry) {
    this._sink = _sink;
    this._carry = _carry;
    this.$deferredAction();
  }
  ...
  _LineSplitterSink.$__fields__ = ["_sink", "_carry"];
  ...
  function NoSuchMethodError_toString_closure(_box_0) {
    this._box_0 = _box_0;
    this.$deferredAction();
  }
  ...
  NoSuchMethodError_toString_closure.$__fields__ = ["_box_0"];
  function bool() {
    this.$deferredAction();
  }
  ...
  _EventStreamSubscription.$__fields__ = ["_pauseCount", "_target", "_eventType", "_onData", "_useCapture"];
...
}, "_ctx", "_logger0", "get$_logger0", function() {
...
{func: "", args: [V.ServerService]},
{func: "", args: [V.ServerService, V.ServerService]},
